var FormWizard = function () {
    ...
    var onFinish = function (obj, context) {
        if (validateAllSteps()) {
            ...
            posting.done(function( data ) {
                console.log(data);
                toastr.info("Requerimiento Guardado Exitosamente");
                window.location=base_url+"est/requerimiento/asignacion/"+ data;
            ...
            /*posting.done(function( data ) {
                ...
                $("#form input[name='areas_cargos[]']").each(function(i,value){
                    ...
                    //jAlert('Area Cargo Ingresado', 'Registrado con Exito');
                    ...
                    posting2.done(function( data ) {
                        ...
                        if (i == len - 1) {
                            ...
                            window.location=base_url+"est/requerimiento/listado";
                        }
                    });
                });
            });*/
    ...
    var validateSteps = function (stepnumber, nextstep) {
        ...
        if(stepnumber == 1){
            var form = $( '#form' );
            var codigo_requerimiento = form.find("input[name='codigo_requerimiento']").val();
            var n_solicitud = form.find("input[name='n_solicitud']").val();
            var f_solicitud = form.find("input[name='f_solicitud']").val();
            var select_regimen = form.find("select[name='select_regimen']").val();
            var select_planta = form.find("select[name='select_planta'] option:selected").val();
            var motivo = form.find("input[name='motivo']").val();
            var causal = form.find("input[name='causal']").val();
            var fdesde = form.find("input[name='fdesde']").val();
            var fhasta = form.find("input[name='fhasta']").val();
