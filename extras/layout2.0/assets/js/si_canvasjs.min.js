...
/*
if("undefined"===typeof ma.Chart.creditHref)this.creditHref="http://canvasdsvsjs.com/",this.creditText="CanvsgvdasJS.com";
else var c=this.updateOption("creditText"),d=this.updateOption("creditHref");
*/
if(0===this.renderCount||c||d)this._creditLink.setAttribute("href",this.creditHref),
