...
$(document).ready(function () {
  $('#datepickerEnjoySCompletas').datepicker({
    ...
    language: 'ES',
      ...
      location.href=base_url+"wood/contratos/solicitudes_completas/"+fecha_seleccionada;
      });
});

function historico(){
   location.href=base_url+"wood/contratos/solicitudes_completas/historico";
}
...
$(document).ready(function () {
  $('#datepickerEnjoyRequerimientos').datepicker({
    ...
    language: 'ES',
      ...
      fecha_seleccionada = $(this).val();
      location.href=base_url+"wood/requerimientos/listado/"+fecha_seleccionada;
      });
});
function historicoRequerimiento(){
   location.href=base_url+"wood/requerimientos/listado/historico";
}
...
$(document).ready(function () {
  $('#datepickerEnjoyBajadas').datepicker({
    ...
    language: 'ES',
      ...
      fecha_seleccionada = $(this).val();
      location.href=base_url+"wood/contratos/solicitudes_completas_baja/"+fecha_seleccionada;
      });
});

function historicoBajas(){
   location.href=base_url+"wood/contratos/solicitudes_completas_baja/historico";
}