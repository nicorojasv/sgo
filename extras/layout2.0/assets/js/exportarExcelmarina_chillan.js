...
$(document).ready(function () {
  $('#datepickermarinaSCompletas').datepicker({
    ...
    language: 'ES',
      ...
      location.href=base_url+"marina_chillan/contratos/solicitudes_completas/"+fecha_seleccionada;
      });
});

function historico(){
   location.href=base_url+"marina_chillan/contratos/solicitudes_completas/historico";
}
...
$(document).ready(function () {
  $('#datepickerMarinaRequerimientos').datepicker({
    ...
    language: 'ES',
      ...
      fecha_seleccionada = $(this).val();
      location.href=base_url+"marina_chillan/requerimientos/listado/"+fecha_seleccionada;
      });
});
function historicoRequerimiento(){
   location.href=base_url+"marina_chillan/requerimientos/listado/historico";
}
//Listado de bajas
$(document).ready(function () {
  $('#datepickerMarinaBajadas').datepicker({
    ...
    language: 'ES',
      ...
      fecha_seleccionada = $(this).val();
      location.href=base_url+"marina_chillan/contratos/solicitudes_completas_baja/"+fecha_seleccionada;
      });
});

function historicoBajas(){
   location.href=base_url+"marina_chillan/contratos/solicitudes_completas_baja/historico";
}