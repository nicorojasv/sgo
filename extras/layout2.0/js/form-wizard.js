        ...
        if (validateAllSteps()) {
            ...
            posting.done(function( data ) {
                ...
                $("#form input[name='areas_cargos[]']").each(function(i,value){
                    ...
                    formulario2.id_requerimiento = id_requerimiento;
                    formulario2.salida = salida;
                    var json = JSON.stringify(formulario2);
                    var posting2 = $.post( base_url + "est/requerimiento/guardar_area_cargo",{area_cargo : json},function(){ toastr.info("Guardando Requerimiento"); });
