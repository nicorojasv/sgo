$(document).ready(function(){
	...
	$("#planta").change(function(){
		...
		$.ajax({
			type: "POST",
			url: base_url + "/administracion/requerimiento/ajax_grupo/"+id_planta,
			dataType: "json",
	...
	$("#grupo").change(function(){
		...
		$.ajax({
			type: "POST",
			url: base_url + "/administracion/requerimiento/ajax_areas2/"+id_grupo,
			dataType: "json",
			success: function(datos){
	...
	$("#area").change(function(){
		...
		$.ajax({
			type: "POST",
			url: base_url + "/administracion/requerimiento/ajax_cargos2/"+id_grupo+"/"+id_area,
			dataType: "json",
			success: function(datos){
