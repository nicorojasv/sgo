$(document).ready(function(){
	...
	$.ajax({
		async:false,
	  	url: base_url + 'mandante/requerimiento/ajax_cargos/'+ $('#idplanta').val(),
	...
	$.ajax({
		async:false,
	  	url: base_url + 'mandante/requerimiento/ajax_areas/'+ $('#idplanta').val(),
	  	success: function(data) {
			ajax_areas = data;
		}
	});
	...
	$.ajax({
		async:false,
	  	url: base_url + 'mandante/requerimiento/ajax_especialidades',
	  	success: function(data) {
	...
	$.ajax({
		async:false,
	  	url: base_url + 'mandante/requerimiento/ajax_centrocostos/'+ $('#idplanta').val(),
	  	success: function(data) {
	...
	$(".jcargo").live('change',function(){
		...
		cant = $(this).nextAll('.chicos').children(".jcantidad").attr("name");
		//desd = $(this).next().next().next().next().next().next().children(".jfdesde").attr("name");
		desd = $(this).nextAll('.chicos').children(".jfdesde").attr("name");
//		hast = $(this).next().next().next().next().next().next().children(".jfhasta").attr("name");
		hast = $(this).nextAll('.chicos').children(".jfhasta").attr("name");
		tot_cant = cant.split(/\D/);
		tot_cant = $.grep(tot_cant,function(n,i){  return(n);});
		//alert(tot_cant);
		tot_desd = desd.split(/\D/);
...
//		$(this).next().next().next().next().next().next().children(".jcant_antiguo").attr("name","antiguo_rt[" + id + "]["+ id_cargo + "][" + valor_hast2 +"][]");
		$(this).nextAll('.chicos').children(".jcantidad").attr("name","cantidad[" + id + "]["+ id_cargo + "][" + valor_cant2 +"][]");
		$(this).nextAll('.chicos').children(".jfdesde").attr("name","fdesde[" + id + "]["+ id_cargo + "][" + valor_desd2 +"][]");
		$(this).nextAll('.chicos').children(".jfhasta").attr("name","fhasta[" + id + "]["+ id_cargo + "][" + valor_hast2 +"][]");
		$(this).nextAll('.chicos').children(".jcc").attr("name","select_cc[" + id + "]["+ id_cargo + "][" + valor_hast2 +"][]");
		$(this).nextAll('.chicos').children(".jcant_antiguo").attr("name","antiguo_rt[" + id + "]["+ id_cargo + "][" + valor_hast2 +"][]");
...
//		$(this).next().next().next().next().next().find(".jcant_antiguo").attr("name","antiguo_rt[" + id + "]["+ valor_hast1 + "][" + id_especialidad +"][]");
		$(this).nextAll('.chicos').find(".jcantidad").attr("name","cantidad[" + id + "]["+ valor_cant1 + "][" + id_especialidad +"][]");
		$(this).nextAll('.chicos').find(".jfdesde").attr("name","fdesde[" + id + "]["+ valor_desd1 + "][" + id_especialidad +"][]");
		$(this).nextAll('.chicos').find(".jfhasta").attr("name","fhasta[" + id + "]["+ valor_hast1 + "][" + id_especialidad +"][]");
		$(this).nextAll('.chicos').find(".jcc").attr("name","select_cc[" + id + "]["+ valor_hast1 + "][" + id_especialidad +"][]");
		$(this).nextAll('.chicos').find(".jcant_antiguo").attr("name","antiguo_rt[" + id + "]["+ valor_hast1 + "][" + id_especialidad +"][]");
