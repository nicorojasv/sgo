...
(function () {
    ...
    e.extend(h.prototype, {
        ...
        hasAttribute: (function () {function i(j) {
        ...
        mergeSiblings: (function () {function i(j, k, l) {
                if (k && k.type == 1) {
                    var m = [];
    ...
    (function () {function l(s, t) {
        ...
        d.walker.bookmark = function (s, t) {function u(v) {
        ...
        d.walker.bogus = function (s, t) {function u(v) {
                return !p(v) && !q(v);
            };
            return function (v) {
                var w = v.getParent(),
    ...
    (function () {
        ...
        d.range.prototype = {
            ...
            checkReadOnly: (function () {function u(v, w) {
                    while (v) {
            ...
            moveToElementEditablePosition: function (u, v) {function w(y, z) {
                    var A;
    ...
    (function () {function m(n, o, p, q, r, s, t) {
            var u = n.config,
                v = r.split(';'),
                w = [],
                x = {};
