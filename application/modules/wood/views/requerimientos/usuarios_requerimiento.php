...
<div class="panel panel-white">
	...
	<div class="panel-body">
		<form action="<?php echo base_url() ?>wood/trabajadores/solicitudes_revision_examenes" method="post">
			<div class="col-md-8">
				<a href="<?php echo base_url() ?>wood/requerimientos/asignacion/<?php echo $id_requerimiento ?>"><i class="fa fa-reply"></i></a>
			...
			<div class="col-md-4">
	          	<a data-style="slide-right" class='btn btn-blue' href="<?php echo base_url() ?>wood/requerimientos/usuarios_requerimientos_listado/<?php echo $area_cargo ?>">Agregar trabajadores</a>
				...
				<tbody>
					<?php foreach ($listado as $l) { ?>
						<tr <?php if($paso_usuario){ echo ($l->usuario_id==$paso_usuario)?"style='background-color:#E6E6E6;'":""; } ?>>
							...
							<td>
								<a href="#" class="dob" data-type="combodate" data-name="fecha" data-value="<?php echo $l->fecha; ?>" data-format="YYYY-MM-DD" data-viewformat="DD/MM/YYYY" data-template="DD / MMM / YYYY" data-pk="<?php echo $l->id ?>" data-url="<?php echo base_url() ?>wood/requerimientos/guardar_fecha"  data-original-title="Fecha de Ingreso"></a>
							</td>
							<td class="center">
								<a href="#" class="opcion_referido" data-type="select" data-name="referido" data-pk="<?php echo $l->id ?>" data-value="" data-url="<?php echo base_url() ?>wood/requerimientos/guardar_fecha" data-original-title="Select sex">
							...
							<td class="center">
								<a href="<?php echo base_url().'wood/requerimientos/contratos_req_trabajador/'.$l->usuario_id ?>/<?php echo $l->id ?>/<?php echo $l->id_req ?>" style="color:blue;" target="_blank">
									<i class="fa fa-book" ></i>
									<?php echo $l->cantidad_contratos_realizados_generados."/".$l->cantidad_contratos_realizados ?>
								</a>
							</td>
							<td class="center">
								<a href="#" class="opcion_status" data-type="select" data-name="status" data-pk="<?php echo $l->id ?>" data-value="" data-url="<?php echo base_url() ?>wood/requerimientos/guardar_fecha" data-original-title="Seleccione Estado">
									<?php 
									if ($l->status){
							...
							<td>
								<a href="#" class="opcion_jefe_area" data-type="text" data-name="jefe_area" data-pk="<?php echo $l->id ?>" data-value="" data-url="<?php echo base_url() ?>wood/requerimientos/guardar_fecha" data-original-title="Jefe de Area">
								<?php echo $l->jefe_area ?></a>
							</td>
							<td>
								<a href="#" class="comments" data-type="text" data-pk="<?php echo $l->id ?>" data-name="comentario" data-url="<?php echo base_url() ?>wood/requerimientos/guardar_fecha" data-placeholder="Agregar comentario..." data-original-title="Comenta">
									<?php echo ($l->comentario)? $l->comentario : ''; ?>
								</a>
							</td>
							<td class="center">
								<a class='eliminar' href="<?php echo base_url() ?>wood/requerimientos/eliminar_usuarios_req/<?php echo $l->id ?>/<?php echo $area_cargo ?>"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
