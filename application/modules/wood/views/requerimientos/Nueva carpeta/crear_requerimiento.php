<div class="panel panel-white" >
	...
	<div class="panel-body">
		<form action="<?php echo base_url() ?>logistica_servicios/requerimientos/guardar_datos_requerimiento" class="smart-wizard form-horizontal" role="form" id="form" method='post' name="formulario">
			<div id="wizard" class="swMain">
				...
				<div class="stepContainer" style="height: 353px;">
					...
					<div id="step-1" class="content" style="display: block;">
						...
						<div class="form-group">
							...
							<div class="col-sm-7" >
								<div class="input-group">
									<input type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" name="f_solicitud" class="form-control date-picker" required>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">
								Planta <span class="symbol required"></span>
							</label>
							<div class="col-sm-7" >
								<div class="row">
									<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-7" >
								<input type="text" name="causal" class="form-control" maxlength="4" required>
							</div>
						</div>
						<div class="form-group">	
							<label class="col-sm-3 control-label">
							...
							<div class="col-sm-7" >
								<div class="row">
									<div class="col-md-6">
										<div class="input-group">
											<input type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" name="fdesde" class="form-control date-picker" required>
											<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
										</div>
									</div>
									<div class="col-md-6">
										<div class="input-group">
											<input type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" name="fhasta" class="form-control date-picker" required>
											<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
										</div>
									</div>
								</div>
