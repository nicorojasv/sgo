   ...
   $('#agregarContrato').attr('disabled','disabled')
    ...
    $(document).ready(function(){
      ...
      <?php 
       ...
       ?>
<div id="modal">
  <form action="<?php echo base_url() ?>wood/requerimientos/actualizar_anexo/<?php echo $anexos->id ?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
