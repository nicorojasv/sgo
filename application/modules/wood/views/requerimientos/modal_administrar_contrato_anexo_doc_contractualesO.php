<div id="modal">
  <form action="<?php echo base_url() ?>wood/requerimientos/actualizar_contrato_anexo_doc_contractual/<?php echo $id_usu_arch?>/<?php echo $id_area_cargo?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" onsubmit ="return bloqEnvio()" >
        ...
        <div class="col-md-6" style="text-align: center" id="blw">
          ...
          <?php if($rechazado == 1 && !empty($usu->comentarios))echo " <b>Observacion:</b> ".$usu->comentarios; ?>
            ...
            <?php
                ...
                ?>
                    <label>Puede ver el contrato vigente <a href="<?php echo base_url()?>wood/requerimientos/contratos_req_trabajador/<?php echo $key->idUsuario."/".$key->id."/".$key->idAreaCargo ?>">aquí</a></label>
                <?php      
                  }
                ?>
