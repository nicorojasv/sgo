<div class="panel panel-white">
	<div class="panel-heading">
		<h4 class="panel-title">A&ntilde;adir Evaluaci&oacute;n Medica <a href="<?php echo base_url() ?>wood/trabajadores/detalle/<?php echo $id ?>"><i class="fa fa-reply"></i></a></h4>
	</div>
	<div class="panel-body">
		<form class="form-horizontal" id="agregar_examen" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>wood/trabajadores/guardar_creacion_eval/<?php echo $id ?>/<?php if($eval){ echo $eval->id; } ?>">
