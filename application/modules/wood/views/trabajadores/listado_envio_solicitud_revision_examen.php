					...
					<table id="example1">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a title="Eliminar Solicitud" class="eliminar" href="<?php echo base_url() ?>wood/trabajadores/eliminar_solicitud_previa_revision_examen/<?php echo $row->id_solicitud_previa ?>"><i class="fa fa-trash-o"></i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
