<div class="panel panel-white">
	<div class="panel-heading">
		<h4 class="panel-title">Listado de Horarios wood</h4>
	</div>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td class="center">
							<a data-toggle="modal" href="<?php echo base_url() ?>wood/horarios/modal_editar/<?php echo $l->id ?>" class="btn btn-xs btn-blue tooltips editar" data-target="#ModalEditar"><i class="fa fa-edit"></i></a>
							<!--
							<a href="<?php echo base_url() ?>wood/horarios/eliminar/<?php echo $l->id ?>" class="btn btn-xs btn-red tooltips eliminar" data-placement="top" data-original-title="Eliminar"><i class="fa fa-times fa fa-white"></i></a>
							-->
						</td>
					</tr>
				<?php
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url() ?>wood/horarios/guardar_nuevo_horario" method='post'>
					<div class="col-md-12">
