...
class Requerimientos extends CI_Controller {
	public function __construct(){
		...
		elseif( $this->session->userdata('tipo_usuario') == 14)
			$this->menu = $this->load->view('layout2.0/menus/wood_menu_admin','',TRUE);
		elseif( $this->session->userdata('tipo_usuario') == 15)
			$this->menu = $this->load->view('layout2.0/menus/wood_menu_admin_supervisor','',TRUE);
	...
	function index(){
		redirect('wood/requerimientos/listado', 'refresh');
	}
	...
	function agregar(){
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'wood/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Crear Requerimiento' )),
		...
		$this->load->model("wood/Cargos_model");
		$this->load->model('wood/Empresas_model');
		$this->load->model('wood/Centrocostos_model');
		$this->load->model("wood/Empresa_planta_model");
		//$this->load->model("wood/Relacion_usuario_planta_model");
		$this->load->model('wood/Requerimientos_model');
	...
	function asignacion($id){
		$this->load->model("wood/Requerimiento_area_cargo_model");
		$this->load->model('wood/Requerimientos_model');
		$this->load->model('wood/Empresa_planta_model');
		$this->load->model('wood/Areas_model');
		$this->load->model('wood/Cargos_model');
		$this->load->model('wood/Requerimiento_asc_trabajadores_model');
		...
		$base = array(
			...
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'wood/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Asignar Areas - Cargos Requerimiento' )),
			'menu' => $this->menu
		);
		...
		$base['cuerpo'] = $this->load->view('wood/requerimientos/asignar_area_cargo_requerimiento',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function guardar_area_cargo_req(){
		...
		redirect('wood/requerimientos/asignacion/'.$id_req.'', 'refresh');
	}
	...
	function listado($fecha = false){
		$base = array(
			...
			'menu' => $this->menu,
			'js' => array('js/confirm.js','plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/lista_req.js','js/exportarExcelWood.js'),
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css'),
		);
		...
		$base['cuerpo'] = $this->load->view('wood/requerimientos/listado',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function usuarios_requerimiento($id_area_cargo = false, $id_usuario = FALSE){
		...
		$this->load->model("wood/Requerimiento_Usuario_Archivo_model");
		$this->load->model("wood/Requerimiento_asc_trabajadores_model");
		$this->load->model("wood/Requerimiento_area_cargo_model");
		$this->load->model("wood/Requerimientos_model");
		$this->load->model('wood/Archivos_trab_model');
		$this->load->model('wood/Empresas_model');
		$this->load->model("wood/Evaluaciones_model");
		$this->load->model("wood/Usuarios_model");
		$this->load->model('wood/Planta_model');
		$this->load->model("wood/Areas_model");
		$this->load->model("wood/Cargos_model");
		$this->load->model("wood/Empresa_planta_model");
		$this->load->model("wood/Listanegra_model");
		$this->load->model("wood/Solicitud_revision_examenes_model");
		...
		if( $this->session->userdata('cargo') == 9 and $this->session->userdata('centro_costo') == 7 and $this->session->userdata('departamento') == 2 and $this->session->userdata('sucursal') == 11){
			$base = array(
				'head_titulo' => "Sistema wood",
				'titulo' => "Usuarios asignados",
				'subtitulo' => '',
				'side_bar' => false,
				'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'wood/requerimiento/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Lista de usuarios' )),
				'menu' => $this->menu,
			...
			$base = array(
				...
				'subtitulo' => '',
				'side_bar' => false,
				'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'wood/requerimiento/listado','txt' => 'Requerimientos'), array('url'=>'wood/requerimiento/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Lista de usuarios' )),
				'menu' => $this->menu,
		...
		$pagina['agregados'] = $i;
		$base['cuerpo'] = $this->load->view('wood/requerimientos/usuarios_requerimiento',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function usuarios_requerimientos_listado($id_area_cargo){
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'wood/requerimientos/usuarios_requerimiento/'.$id_area_cargo."", 'txt'=>'Volver a la Area - Cargo del Requerimiento'), array('url'=>'','txt'=>"Listado Trabajadores requerimiento ".$this->Requerimientos_model->get($id_req)->nombre."" )),
			'menu' => $this->menu,
		...
		$base['cuerpo'] = $this->load->view('wood/requerimientos/listado_usuarios_req',$pagina, TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function agregar_usuarios_requerimiento(){
		...
		redirect('wood/requerimientos/usuarios_requerimiento/'.$id_area_cargo, 'refresh');
	}
	...
	function contratos_req_trabajador($id_usuario,$id_asc_area_req,$id_area_cargo_req = FALSE,$agregandoAnexo= FALSE){
		...
		$this->load->model("wood/Requerimiento_area_cargo_model");
		$this->load->model("wood/Usuarios_model");
		$this->load->model("wood/ciudades_model");
		$this->load->model("wood/Afp_model");
		$this->load->model("wood/Salud_model");
		$this->load->model("wood/estado_civil_model");
		$this->load->model("wood/Requerimientos_model");
		$this->load->model("wood/Nivel_estudios_model");
		$this->load->model("wood/Areas_model");
		$this->load->model("wood/Cargos_model");
		$this->load->model("wood/Empresas_model");
		$this->load->model("wood/Empresa_planta_model");
		$this->load->model("wood/regiones_model");
		$this->load->model("wood/Tipo_gratificacion_model");
		$this->load->model("wood/Solicitud_revision_examenes_model");
		$this->load->model("wood/Descripcion_horarios_model");
		...
		$base = array(
			...
			'lugar' => array(
							...
							array('url'=>'wood/requerimientos/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), 
							array('url'=>'wood/requerimientos/usuarios_requerimiento/'.$id_area_cargo_req,'txt'=>'Lista de usuarios' ), 
...
//18138050*/
		...
		$base['cuerpo'] = $this->load->view('wood/requerimientos/documentos_contractuales_contratos_req',$pagina, TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function eliminar_contratos_req_trabajador($id_usuario, $id_asc_area_req, $id_area_cargo_req, $id_req_usu_arch){
		...
		redirect('wood/requerimientos/contratos_req_trabajador/'.$id_usuario.'/'.$id_asc_area_req.'/'.$id_area_cargo_req.'', 'refresh');
	}
	...
	function modal_agregar_contrato_anexo($usuario,$tipo,$asc_area, $id_req_area_cargo){
		...
		$this->load->view('wood/requerimientos/modal_agregar_contrato_anexo_doc_contractuales', $pagina);
	}
	...
	function guardar_nuevo_contrato_anexo_doc_contractual($usuario,$tipo,$asc_area){
		...
		redirect('wood/requerimientos/contratos_req_trabajador/'.$usuario.'/'.$asc_area.'/'.$id_area_cargo.'', 'refresh');
	}
	...
	function modal_administrar_contrato_anexo_doc_general($id_usu_arch,$id_area_cargo){
		...
		$this->load->model("wood/Solicitud_revision_examenes_model");
		$this->load->model("wood/Descripcion_horarios_model");
		$this->load->model("wood/Sre_evaluacion_req_model");
		...
		$this->load->view('wood/requerimientos/modal_administrar_contrato_anexo_doc_contractuales', $pagina);
	}
	function qwea(){
		$fecha = 
	...
	function actualizar_contrato_anexo_doc_contractual($id_usu_arch,$id_area_cargo){
		$this->load->model("wood/Requerimiento_Usuario_Archivo_model");
		$this->load->model("wood/Descripcion_causal_model");
		$this->load->model("wood/Descripcion_horarios_model");
		...
		if(isset($_POST['actualizar'])){
		    ...
		    $this->email->from('informaciones@empresasintegra.cl', 'Solicitud Contrato SGO - WOOD');
		    $this->email->to('nrojaswood/@empresasintegra.cl');
		   // $this->email->cc('jcruces@empresasintegra.cl');
			...
			if($id_planta == 2)
				$template_formato = base_url()."extras/contratos/formatos_contratos_est/3_contrato_parte_2_con_4_documentos_celulosa_WOOD.docx";
			elseif($id_planta == 3)
	...
	function eliminar_usuarios_req($id,$area_cargo){
		...
		redirect('wood/requerimientos/usuarios_requerimiento/'.$area_cargo, 'refresh');
	}
	...
	function eliminar($id){
		...
		redirect(base_url().'wood/requerimientos/listado', 'refresh');
	}
...
function descargar_puesta_disposicion($id){
		...
		if ($requerimientos->letraCausal== 'A') {
			...
			$template_formato = base_url()."extras/contratos/formatos_contrato_disposicion/formatoContratoPuestaDisposicionWood.docx";
			$templateWord = new TemplateProcessor($template_formato);
			$salto_linea = "<w:br/>";
	...
	function modal_agregar_anexo($usuario,$tipo,$asc_area, $id_req_area_cargo){
		...
		$pagina['datos_req'] = $datos_req;
		$pagina['tipo_jornada'] = $tipo_jornada;
		$this->load->view('wood/requerimientos/modal_crear_anexo', $pagina);
	}
...
function descargar_carta_termino($id_usuario, $idArchivo, $tipoArchivo){
	...
	function modal_administrar_archivo_usu($id_req_usu_arch = FALSE, $id_area_req = FALSE){
		...
		$this->load->view('wood/requerimientos/modal_administrar_doc_contractuales', $pagina);
	}
	...
	function callback_view_documentos($id_usuario,$id_asc_area_req,$id_req = FALSE){
		$this->load->model("wood/tipoarchivos_requerimiento_model");
		$this->load->model("wood/requerimiento_usuario_archivo_model");
		$this->load->model("wood/Tipoarchivos_model");
		$this->load->model("wood/Archivos_trab_model");
		$this->load->model("wood/Usuarios_model");
		$this->load->model("wood/Evaluaciones_model");
		$this->load->model("wood/Requerimiento_area_cargo_model");
		$this->load->model("wood/Pensiones_Requerimiento_model");
		$this->load->model("wood/Pensiones_Valores_model");
		$this->load->model("wood/Pensiones_model");
		$usr = $this->Usuarios_model->get($id_usuario);
		...
		$this->load->view('wood/requerimientos/documentos_contractuales',$base);
	}
	function modal_administrar_anexo($idAnexo, $id_area_cargo){
		...
		$this->load->view('wood/requerimientos/modal_administrar_anexo', $pagina);
	}
	...
	function enviar_revision($id= false){
		...
		if ($resultado == 1) {
			$this->load->library('email');
				...
				$config['smtp_port']    = '2552';
				$this->email->initialize($config);
			    $this->email->from('informaciones@empresasintegra.cl', 'Solicitud Anexo SGO - Wood');
	...
	//inicio de boton generar anexo
		...
		//var_dump($datos); return false;
		if ($datos->estado == 2) {
				$template_formato = base_url()."extras/contratos/anexos/anexowood.docx";
				$templateWord = new TemplateProcessor($template_formato);
				$salto_linea = "<w:br/>";
...
function modal_cargar_anexo($idAnexo, $id_area_cargo= false){
		...
		$this->load->view('wood/requerimientos/modal_subir_anexo', $pagina);
	}
	...
	function actualizar_anexo($id=false){
		...
		redirect('wood/requerimientos/contratos_req_trabajador/'.$datosAnexoContrato->usuario_id.'/'.$datosAnexoContrato->requerimiento_asc_trabajadores_id.'/'.$datosAnexoContrato->id_requerimiento_area_cargo.'', 'refresh');
	}
}
