...
class Asistencia extends CI_Controller{
	public function __construct(){
		...
		$this->load->model("wood/Asistencia_model");
	...
	function guardar_asistencia(){
		...
		redirect('wood/asistencia/index/'.$fechaTrabajando,'refresh');
	}
	...
	function guardar_estado_asistencia(){// guardando estado de los trabajadores activos
		...
		redirect('wood/asistencia/listado_activo_personal','refresh');
	}
	...
	function guardar_bono(){
		...
		$this->session->set_userdata('exito',1);
		redirect('wood/asistencia/bonos/'.$fechaTrabajando,'refresh');
	}
