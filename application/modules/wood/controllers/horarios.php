...
class Horarios extends CI_Controller{
	...
	function index(){
		$base = array(
			'head_titulo' => "Sistema EST - Listado de Horarios WOOD",
			'titulo' => "Horarios Wood",
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url' => '', 'txt' => 'Horarios wood')),
			'menu' => $this->menu,
		...
		$base['cuerpo'] = $this->load->view('wood/horarios/listado',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}

	function modal_editar($id){
		$pagina['datos_horario'] = $this->Descripcion_horarios_model->get_result($id);
		$this->load->view('wood/horarios/modal_editar_horario', $pagina);
	}
	...
	function guardar_nuevo_horario(){
		...
		redirect('wood/horarios', 'refresh');
	}
