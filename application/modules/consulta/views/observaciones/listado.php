	...
	<table class="data display">
		...
		<tbody>
			...
			<tr>
				...
				<td><a target="_blank" href="<?php echo base_url() ?>consulta/trabajador/perfil/<?php echo $l->id_usuario ?>"><?php echo $l->nombres ?> <?php echo $l->paterno ?> <?php echo $l->materno ?></a></td>
