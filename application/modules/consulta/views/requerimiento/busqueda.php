<script src="<?php echo base_url() ?>extras/js/ajax_consulta.js" type="text/javascript"></script>
<div class="span11 offset0">
	<form class="form-inline" action="<?php echo base_url() ?>consulta/requerimiento" method='post'>
		<label>Planta: </label>
