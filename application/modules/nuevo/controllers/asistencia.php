...
class Asistencia extends CI_Controller{
	public function __construct(){
		...
		$this->load->model("enjoy/Asistencia_model");
	...
	function guardar_asistencia(){
		...
		redirect('enjoy/asistencia/index/'.$fechaTrabajando,'refresh');
	}
	...
	function guardar_estado_asistencia(){// guardando estado de los trabajadores activos
		...
		redirect('enjoy/asistencia/listado_activo_personal','refresh');
	}
	...
	function guardar_bono(){
		...
		$this->session->set_userdata('exito',1);
		redirect('enjoy/asistencia/bonos/'.$fechaTrabajando,'refresh');
	}
