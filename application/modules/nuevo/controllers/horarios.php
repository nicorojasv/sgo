...
class Horarios extends CI_Controller{
	...
	function index(){
		$base = array(
			'head_titulo' => "Sistema EST - Listado de Horarios ENJOY",
			'titulo' => "Horarios ENJOY",
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url' => '', 'txt' => 'Horarios ENJOY')),
			'menu' => $this->menu,
	...
	function modal_editar($id){
		...
		$this->load->view('enjoy/horarios/modal_editar_horario', $pagina);
	}
	...
	function guardar_nuevo_horario(){
		...
		redirect('enjoy/horarios', 'refresh');
	}
