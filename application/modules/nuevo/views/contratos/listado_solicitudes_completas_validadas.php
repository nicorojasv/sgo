      ...
      <label for="historico" style="cursor: pointer;" >Historico</label>
        ...
        <?php }?>
          <div class="col-md-4" align="center">
            <form action="<?php echo base_url() ?>enjoy/contratos/exportar_excel_contratos_y_anexos" method="post" target="_blank" id="FormularioExportacion">
              <input title="EXPORTAR DATOS A ARCHIVO EXCEL" type="submit" class="botonExcelEnjoy btn btn-success btn-block" value="Exportar a Excel"><br>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url() ?>enjoy/contratos/solicitud_bajar_contrato/<?php echo $rm->id_req_usu_arch ?>" title="Solicitar baja contrato" onClick="if(confirm('¿Esta seguro de dar de baja este contrato ?')) return true; else return false;"><i class="fa fa-sign-out" style="color: red" aria-hidden="true"></i></a>
                  <?php } ?>
