			...
			<tbody>
				<?php foreach ($listado as $l) { ?>
					<tr>
						...
						<!--<td class="center">
								<a class="eliminar" href="<?php //echo base_url() ?>enjoy/trabajadores/eliminar_anotacion/<?php // echo $usuario->id ?>/<?php //echo $l->lista_id; ?>"><i class="fa fa-trash-o"></i></a>
...
<div id="sv-listado" class="no-display">
	<div class="col-md-12">
		<br />
		<form class="form-horizontal" method="post" role="form" action="<?php echo base_url() ?>enjoy/trabajadores/guardar_anotacion/<?php echo $usuario->id; ?>" enctype="multipart/form-data">
