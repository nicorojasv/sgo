...
<div id="modal">
  ...
  <form action="<?php echo base_url() ?>enjoy/requerimientos/guardar_nuevo_contrato_anexo_doc_contractual/<?php echo $usuario ?>/<?php echo $tipo ?>/<?php echo $asc_area ?>" role="form"  @submit="checkForm" id="form2" method='post' name="f2" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
          ...
          <div class="control-form">
            ...
            <select name="mes_fi" id="mes_fi" style="width: 33%;" >
              ...
              <option value='08' <?php if($bloqear!=false){if($mes_fi>'08'){echo 'disabled';}}  echo ($mes_fi == '8')? "selected='selected'" : '' ?>>Agosto</option>
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select name="mes_ft" id="mes_ft" style="width: 33%;" >
              ...
              ?>
              <option value='01' <?php if($bloqear2!=false){if($mes_ft>'01'){echo 'disabled';}} echo ($mes_ft == '1')? "selected='selected'" : '' ?>>Enero</option>
              <option value='02' <?php if($bloqear2!=false){if($mes_ft>'02'){echo 'disabled';}} echo ($mes_ft == '2')? "selected='selected'" : '' ?>>Febrero</option>
              <option value='03' <?php if($bloqear2!=false){if($mes_ft>'03'){echo 'disabled';}} echo ($mes_ft == '3')? "selected='selected'" : '' ?>>Marzo</option>
              <option value='04' <?php if($bloqear2!=false){if($mes_ft>'04'){echo 'disabled';}} echo ($mes_ft == '4')? "selected='selected'" : '' ?>>Abril</option>
              <option value='05' <?php if($bloqear2!=false){if($mes_ft>'05'){echo 'disabled';}} echo ($mes_ft == '5')? "selected='selected'" : '' ?>>Mayo</option>
              <option value='06' <?php if($bloqear2!=false){if($mes_ft>'06'){echo 'disabled';}} echo ($mes_ft == '6')? "selected='selected'" : '' ?>>Junio</option>
              <option value='07' <?php if($bloqear2!=false){if($mes_ft>'07'){echo 'disabled';}} echo ($mes_ft == '7')? "selected='selected'" : '' ?>>Julio</option>
              <option value='08' <?php if($bloqear2!=false){if($mes_ft>'08'){echo 'disabled';}} echo ($mes_ft == '8')? "selected='selected'" : '' ?>>Agosto</option>
              <option value='09' <?php if($bloqear2!=false){if($mes_ft>'09'){echo 'disabled';}} echo ($mes_ft == '9')? "selected='selected'" : '' ?>>Septiembre</option>
              <option value='10' <?php if($bloqear2!=false){if($mes_ft>'10'){echo 'disabled';}} echo ($mes_ft == '10')? "selected='selected'" : '' ?>>Octubre</option>
              <option value='11' <?php if($bloqear2!=false){if($mes_ft>'11'){echo 'disabled';}} echo ($mes_ft == '11')? "selected='selected'" : '' ?>>Noviembre</option>
              <option value='12' <?php if($bloqear2!=false){if($mes_ft>'12'){echo 'disabled';}} echo ($mes_ft == '12')? "selected='selected'" : '' ?>>Diciembre</option>
            </select>
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select name="mes_fp" id="mes_fp" style="width: 33%;">
              <option value="">Mes</option>
              <option value='01' <?php if($bloqear3!=false){if($mes_fp>'01'){echo 'disabled';}} echo ($mes_fp == '1')? "selected='selected'" : '' ?>>Enero</option>
              <option value='02' <?php if($bloqear3!=false){if($mes_fp>'02'){echo 'disabled';}} echo ($mes_fp == '2')? "selected='selected'" : '' ?>>Febrero</option>
              <option value='03' <?php if($bloqear3!=false){if($mes_fp>'03'){echo 'disabled';}} echo ($mes_fp == '3')? "selected='selected'" : '' ?>>Marzo</option>
              <option value='04' <?php if($bloqear3!=false){if($mes_fp>'04'){echo 'disabled';}} echo ($mes_fp == '4')? "selected='selected'" : '' ?>>Abril</option>
              <option value='05' <?php if($bloqear3!=false){if($mes_fp>'05'){echo 'disabled';}} echo ($mes_fp == '5')? "selected='selected'" : '' ?>>Mayo</option>
              <option value='06' <?php if($bloqear3!=false){if($mes_fp>'06'){echo 'disabled';}} echo ($mes_fp == '6')? "selected='selected'" : '' ?>>Junio</option>
              <option value='07' <?php if($bloqear3!=false){if($mes_fp>'07'){echo 'disabled';}} echo ($mes_fp == '7')? "selected='selected'" : '' ?>>Julio</option>
              <option value='08' <?php if($bloqear3!=false){if($mes_fp>'08'){echo 'disabled';}} echo ($mes_fp == '8')? "selected='selected'" : '' ?>>Agosto</option>
              <option value='09' <?php if($bloqear3!=false){if($mes_fp>'09'){echo 'disabled';}} echo ($mes_fp == '9')? "selected='selected'" : '' ?>>Septiembre</option>
              <option value='10' <?php if($bloqear3!=false){if($mes_fp>'10'){echo 'disabled';}} echo ($mes_fp == '10')? "selected='selected'" : '' ?>>Octubre</option>
              <option value='11' <?php if($bloqear3!=false){if($mes_fp>'11'){echo 'disabled';}} echo ($mes_fp == '11')? "selected='selected'" : '' ?>>Noviembre</option>
              <option value='12' <?php if($bloqear3!=false){if($mes_fp>'12'){echo 'disabled';}} echo ($mes_fp == '12')? "selected='selected'" : '' ?>>Diciembre</option>
            </select>
  ...
  <div class="modal_content">
    <p v-if="errors.length" class="form-control">
    <b>rellene los siguientes campo(s):</b>
    <ul>
 ...
 const app = new Vue({
  ...
  methods:{
    checkForm:function(e) {
      if(this.causal && this.motivo && this.jornada ) return true;
      this.errors = [];
      if(!this.motivo) this.errors.push("Motivo .");
      if(!this.causal) this.errors.push("Causal .");
      if(!this.jornada) this.errors.push("Jornada .");
     // if(!this.fecha) this.errors.push("fecha .");
      e.preventDefault();
    }
  },
  computed:{
      descriptionError: function(){
        var val = this.motivo.trim();
        if (val == '') {
