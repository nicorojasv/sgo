...
<br>
  ...
  <div class="col-md-2">
     <a href="<?php echo base_url() ?>wood/asistencia/listado_activo_personal/2" class="btn btn-col btn-primary">Listado de Personal</a>
  </div>
    <div class="col-md-2" align="center">
          <form action="<?php echo base_url() ?>wood/asistencia/exportar_excel_bono_anticipo" method="post" target="_blank" id="FormularioExportacionBono">
  ...
  ?>
       <form action="<?php echo base_url() ?>wood/asistencia/guardar_bono" method="post" role="form" enctype="multipart/form-data"><br>
