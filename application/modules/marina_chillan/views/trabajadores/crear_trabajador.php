<div class="panel panel-white">
	...
	<hr>
	<form action="<?php echo base_url() ?>marina_chillan/trabajadores/guardar_nuevo_trabajador" method='post'>
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text"  class="form-control" id="rut" name="rut" value="<?php if(!empty($texto_anterior['rut_usuario'])) ?>" required>
				</div>
				<div class="form-group">
					<label class="control-label">
						Nombres <span class="symbol required"></span>
					</label>
					<input type="text"  class="form-control" id="firstname" name="nombres" value="<?php if(!empty($texto_anterior['nombres'])) ?>" required>
				</div>
				<div class="form-group">
					<label class="control-label">
						Apellido Paterno <span class="symbol required"></span>
					</label>
					<input type="text"  class="form-control" id="lastname" name="paterno" value="<?php if(!empty($texto_anterior['paterno'])) ?>" required>
				</div>
				<div class="form-group">
					<label class="control-label">
						Apellido Materno 
					</label>
					<input type="text" class="form-control" id="lastname" name="materno" value="<?php if(!empty($texto_anterior['materno'])) ?>" >
				</div>
				<div class="form-group">
					<label class="control-label">
						Correo Electr&oacute;nico
					</label>
					<input type="email"  class="form-control" id="email" name="email" value="<?php if(!empty($texto_anterior['email'])) ?>" >
				</div>
				<br><br><br>
				<div class="form-group">
					<label class="control-label">
...
$(function () {
    $("#datepicker").datepicker({  changeYear: true,  yearRange: "-70:+0", });
