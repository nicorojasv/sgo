...
<div class="panel panel-white">
	...
	<div class="panel-body">
		<div class="row" >
			...
			<div class="col-md-2">
				<a data-style="slide-right" class="btn btn-blue" href="<?php echo  base_url() ?>marina_chillan/trabajadores/crear" target="_blank"> Agregar Trabajador </a>
				<br><br>
			</div>
			<div class="col-md-3" align="center">
            <form action="<?php echo base_url() ?>marina_chillan/trabajadores/exportar_excel_contratos_y_anexos" method="post" target="_blank" id="FormularioExportacion">
		...
		<table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a title="Editar Trabajador" href="<?php echo base_url() ?>marina_chillan/trabajadores/detalle/<?php echo $row->id_usuario ?>" target="_blank" ><i class="fa fa-pencil fa-fw"></i></a>
						<a href="<?php echo base_url() ?>marina_chillan/trabajadores/anotaciones/<?php echo $row->id_usuario ?>" title="<?php if(empty($row->listaNegra))echo "agregar a lista negra / anotacion"; else echo "en lista negra" ?>"><?php if(empty($row->listaNegra)){ ?><i class="fa fa-thumbs-o-up" aria-hidden="true"></i><?php }else{?><i class="fa fa-thumbs-o-down" style="color:red" aria-hidden="true"></i> <?php }?></a>
						<!--
						<a title="Eliminar Trabajador" class="eliminar" href="<?php echo base_url() ?>marina_chillan/trabajadores/eliminar_trabajador/<?php echo $row->id_usuario ?>"><i class="fa fa-trash-o"></i></a>
						-->
					</td>
				</tr>
				<?php } ?>
...
<script type="text/javascript">
  ...
  //	console.log(value)
                  var datos= value;
                    ...
                    $.ajax({
                      type:"post",
                      url: base_url+"marina_chillan/trabajadores/guardarObservacion/"+id,
  ...
  //  $('.EliminarObservacionMarina').click(function(){
		...
		alertify.confirm('Esta seguro de eliminar Observacion', '', function(){ 
	    		$.ajax({
	            type: "POST",
	            url: base_url+"marina_chillan/trabajadores/eliminar_observacion/"+idUsuario,
	            data: idUsuario,
	            dataType: "json",
		            success: function(data) {  
		            	if (data == 1) {
