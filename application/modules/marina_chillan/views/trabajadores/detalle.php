		...
		<div class="tabbable tabs-left">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="datos-personales">
					...
					<form name="forma" id="forma" role="form" class="form-horizontal" action="<?php echo  base_url() ?>marina_chillan/trabajadores/guardar_personales" method="post" >
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
									<input type="text" class="form-control" onkeypress="return pulsar(event)" name="especialidades" value="<?php echo $datos_usuario->especialidad ?>"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<button type="button" class="btn btn-primary" onclick="forma.submit()">
								Editar Datos
								</button>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="contacto-emergencia" >
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>marina_chillan/trabajadores/guardar_datos_de_emergencia/<?php echo $id_usuario ?>" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-tecnicos">
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>marina_chillan/trabajadores/guardar_tecnicos" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-extras">
					<h2>Datos Extras</h2>
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>marina_chillan/trabajadores/guardar_extra" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
