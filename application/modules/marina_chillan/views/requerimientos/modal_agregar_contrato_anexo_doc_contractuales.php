...
<div id="app">
  ...
  <form action="<?php echo base_url() ?>marina_chillan/requerimientos/guardar_nuevo_contrato_anexo_doc_contractual/<?php echo $usuario ?>/<?php echo $tipo ?>/<?php echo $asc_area ?>" role="form"  id="form2" method='post' name="f2" enctype="multipart/form-data">
          ...
          <div class="controls">
            ...
            */
            ...
            <select class="form-control" name="renta_imponible" id="renta_imponible">
              ...
              <option value="16000" <?php if($renta_anterior == "16000") echo "selected"; ?> >$16.000</option>
              <option value="16500" <?php if($renta_anterior == "16500") echo "selected"; ?> >$16.500</option>
              <option value="17000" <?php if($renta_anterior == "17000") echo "selected"; ?> >$17.000</option>
              <option value="17500" <?php if($renta_anterior == "17500") echo "selected"; ?> >$17.500</option>
              <option value="18000" <?php if($renta_anterior == "18000") echo "selected"; ?> >$18.000</option>
              <option value="19000" <?php if($renta_anterior == "19000") echo "selected"; ?> >$19.000</option>
              ...
              <option value="27000" <?php if($renta_anterior == "27000") echo "selected"; ?> >$27.000</option>
              ...
              <option value="38000" <?php if($renta_anterior == "38000") echo "selected"; ?> >$38.000</option>
              <option value="40000" <?php if($renta_anterior == "40000") echo "selected"; ?> >$40.000</option>
              <option value="44000" <?php if($renta_anterior == "44000") echo "selected"; ?> >$44.000</option>
              ...
              <option value="60000" <?php if($renta_anterior == "60000") echo "selected"; ?> >$60.000</option>
              <option value="70000" <?php if($renta_anterior == "70000") echo "selected"; ?> >$70.000</option>
            </select>
          </div>
        </div>
