<div id="modal">
  <form action="<?php echo base_url() ?>marina_chillan/requerimientos/actualizar_contrato_anexo_doc_contractual/<?php echo $id_usu_arch?>/<?php echo $id_area_cargo?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" onsubmit ="return bloqEnvio()" >
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select class="form-control" name="renta_imponible" id="renta_imponible" <?php if($estado_bloqueo == "si") echo "disabled"; ?>>
              ...
              <option value="17000" <?php if($row->renta_imponible == "17000") echo "selected"; ?> >$17.000</option>
               <option value="17500" <?php if($row->renta_imponible == "17500") echo "selected"; ?> >$17.500</option>
              ...
              <option value="27000" <?php if($row->renta_imponible == "27000") echo "selected"; ?> >$27.000</option>
              ...
              <option value="38000" <?php if($row->renta_imponible == "38000") echo "selected"; ?> >$38.000</option>
              <option value="40000" <?php if($row->renta_imponible == "40000") echo "selected"; ?> >$40.000</option>
              <option value="44000" <?php if($row->renta_imponible == "44000") echo "selected"; ?> >$44.000</option>
              ...
              <option value="60000" <?php if($row->renta_imponible == "60000") echo "selected"; ?> >$60.000</option>
              <option value="70000" <?php if($row->renta_imponible == "70000") echo "selected"; ?> >$70.000</option>
            </select>
          </div>
        </div>
      <?php }else{ ?>
        ...
        <div class="col-md-6" style="text-align: center" id="blw">
          ...
          <?php if($rechazado == 1 && !empty($usu->comentarios))echo " <b>Observacion:</b> ".$usu->comentarios; ?>
            ...
            <?php
                ...
                ?>
                    <label>Puede ver el contrato vigente <a href="<?php echo base_url()?>marina_chillan/requerimientos/contratos_req_trabajador/<?php echo $key->idUsuario."/".$key->id."/".$key->idAreaCargo ?>">aquí</a></label>
                <?php      
                  }
                ?>
