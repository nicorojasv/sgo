...
<div class="panel panel-white">
	...
	<div class="panel-body">
  		<form action="<?php echo base_url() ?>marina_chillan/requerimientos/agregar_usuarios_requerimiento" role="form" id="form" method='post' autocomplete="off">
		<div class="row" >
	      		...
	      		<div class="col-md-10">
					...
					<table id="example1">
						...
						<tbody>
							...
							<tr class="odd gradeX" <?php if($r->listaNegra==true){ ?> style="text-decoration:line-through;" <?php } ?>>
								<td><input type='checkbox' name='check_usuario[]' <?php if($r->listaNegra==true){ ?>  title="Trabajador con restriccion de contratacion" data-nombre="<?php echo $r->nombre ?>" class="trabajadorBloqueado"  <?php } ?> value='<?php echo $r->id_usuario ?>'></td>
