				...
				<tbody>
					<?php foreach ($listado as $l) { ?>
						<tr>
							...
							<td>
								<a href="#" class="dob" data-type="combodate" data-name="fecha" data-value="<?php echo $l->fecha; ?>" data-format="YYYY-MM-DD" data-viewformat="DD/MM/YYYY" data-template="D / MMM / YYYY" data-pk="<?php echo $l->id ?>" data-url="<?php echo base_url() ?>est/requerimiento/guardar_fecha"  data-original-title="Fecha de Ingreso"></a>
							</td>
							<td class="center">
							...
							<td class="center">
								<a class="sv-callback-list" data-usuario='<?php echo $l->usuario_id ?>' href="<?php echo base_url().'est/requerimiento/callback_view_documentos_general/'.$l->usuario_id ?>/<?php echo $l->id ?>/<?php echo $id_requerimiento ?>" style="color:blue;">
									<i class="fa fa-book" ></i>
								</a>
							</td>
							<td class="center">
								<a href="<?php echo base_url().'est/requerimiento/contratos_req_trabajador/'.$l->usuario_id ?>/<?php echo $l->id ?>/<?php echo $l->requerimiento_area_cargo_id ?>" style="color:blue;" target="_blank">
									<i class="fa fa-book" ></i>
							...
							<td class="center">
								<a class='eliminar' href="<?php echo base_url() ?>est/requerimiento/eliminar_usuarios_general_req/<?php echo $l->id ?>/<?php echo $id_requerimiento ?>"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
