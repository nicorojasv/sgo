...
<br>
  <div class="col-md-8">
           <label for="datepickerAsistenciaMarina">Mes A trabajar: </label>
  ...
  <div class="col-md-2">
     <a href="<?php echo base_url() ?>marina_chillan/asistencia/listado_activo_personal" class="btn btn-col btn-primary">Listado de Personal</a>
  </div>
    <div class="col-md-2" align="center">
          <form action="<?php echo base_url() ?>marina_chillan/asistencia/exportar_excel_bono_anticipo" method="post" target="_blank" id="FormularioExportacionAsistencia">
            <input title="EXPORTAR DATOS A ARCHIVO EXCEL" type="submit" class="botonExcelmarinaAsistencia btn btn-info btn-block" value="Exportar"><br>
  ...
  ?>
       <form action="<?php echo base_url() ?>marina_chillan/asistencia/guardar_asistencia" method="post" role="form" enctype="multipart/form-data"><br>
