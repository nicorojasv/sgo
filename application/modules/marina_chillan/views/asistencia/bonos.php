...
<br>
  <div class="col-md-8">
           <label for="datepickerBonoMarina">Mes A trabajar: </label>
  ...
  <div class="col-md-2">
     <a href="<?php echo base_url() ?>marina_chillan/asistencia/listado_activo_personal/2" class="btn btn-col btn-primary">Listado de Personal</a>
  </div>
    <div class="col-md-2" align="center">
          <form action="<?php echo base_url() ?>marina_chillan/asistencia/exportar_excel_bono_anticipo" method="post" target="_blank" id="FormularioExportacionBono">
            <input title="EXPORTAR DATOS A ARCHIVO EXCEL" type="submit" class="botonExcelmarinaBono btn btn-info btn-block" value="Exportar"><br>
  ...
  ?>
       <form action="<?php echo base_url() ?>marina_chillan/asistencia/guardar_bono" method="post" role="form" enctype="multipart/form-data"><br>
