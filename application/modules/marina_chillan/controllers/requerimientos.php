...
class Requerimientos extends CI_Controller {
	public function __construct(){
		...
		elseif( $this->session->userdata('tipo_usuario') == 14)
			$this->menu = $this->load->view('layout2.0/menus/marina_chillan_menu_admin','',TRUE);
		elseif( $this->session->userdata('tipo_usuario') == 15)
			$this->menu = $this->load->view('layout2.0/menus/marina_chillan_menu_admin_supervisor','',TRUE);
	...
	function index(){
		redirect('marina_chillan/requerimientos/listado', 'refresh');
	}
	...
	function agregar(){
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'marina_chillan/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Crear Requerimiento' )),
		...
		$this->load->model("marina_chillan/Cargos_model");
		$this->load->model('marina_chillan/Empresas_model');
		$this->load->model('Centrocostos_model');
		$this->load->model("marina_chillan/Empresa_planta_model");
	...
	function asignacion($id){
		$this->load->model("marina_chillan/Requerimiento_area_cargo_model");
		$this->load->model('marina_chillan/Requerimientos_model');
		$this->load->model('marina_chillan/Empresa_planta_model');
		$this->load->model('marina_chillan/Areas_model');
		$this->load->model('marina_chillan/Cargos_model');
		$this->load->model('marina_chillan/Requerimiento_asc_trabajadores_model');
		...
		$base = array(
			...
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'marina_chillan/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Asignar Areas - Cargos Requerimiento' )),
			'menu' => $this->menu
		);
	...
	function guardar_area_cargo_req(){
		...
		redirect('marina_chillan/requerimientos/asignacion/'.$id_req.'', 'refresh');
	}
	...
	function listado($fecha = false){
		$base = array(
			...
			'menu' => $this->menu,
			'js' => array('js/confirm.js','plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/lista_req.js','js/exportarExcelmarina_chillan.js'),
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css'),
		);
	...
	function usuarios_requerimiento($id_area_cargo, $id_usuario = FALSE){
		$this->load->model("marina_chillan/Requerimiento_Usuario_Archivo_model");
		$this->load->model("marina_chillan/Requerimiento_asc_trabajadores_model");
		$this->load->model("marina_chillan/Requerimiento_area_cargo_model");
		$this->load->model("marina_chillan/Requerimientos_model");
		$this->load->model('marina_chillan/Archivos_trab_model');
		$this->load->model('marina_chillan/Empresas_model');
		$this->load->model("marina_chillan/Usuarios_model");
		$this->load->model("marina_chillan/Areas_model");
		$this->load->model("marina_chillan/Cargos_model");
		$this->load->model("marina_chillan/Empresa_planta_model");
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => false,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'marina_chillan/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'marina_chillan/requerimientos/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Listado de usuarios' )),
			'menu' => $this->menu,
	...
	function usuarios_requerimientos_listado($id_area_cargo){
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'marina_chillan/requerimientos/usuarios_requerimiento/'.$id_area_cargo."", 'txt'=>'Volver a la Area - Cargo del Requerimiento'), array('url'=>'','txt'=>"Listado Trabajadores requerimiento ".$this->Requerimientos_model->get($id_req)->nombre."" )),
			'menu' => $this->menu,
	...
	function agregar_usuarios_requerimiento(){
		...
		redirect('marina_chillan/requerimientos/usuarios_requerimiento/'.$id_area_cargo, 'refresh');
	}
	...
	function contratos_req_trabajador($id_usuario,$id_asc_area_req,$id_area_cargo_req = FALSE){
		...
		$this->load->model("marina_chillan/Requerimiento_area_cargo_model");
		$this->load->model("marina_chillan/Usuarios_model");
		$this->load->model("marina_chillan/Ciudades_model");
		$this->load->model("marina_chillan/Afp_model");
		$this->load->model("marina_chillan/Salud_model");
		$this->load->model("marina_chillan/Estado_civil_model");
		$this->load->model("marina_chillan/Nivel_estudios_model");
		$this->load->model("marina_chillan/Requerimientos_model");
		$this->load->model("marina_chillan/Areas_model");
		$this->load->model("marina_chillan/Cargos_model");
		$this->load->model("marina_chillan/Empresas_model");
		$this->load->model("marina_chillan/Empresa_planta_model");
		$this->load->model("marina_chillan/Regiones_model");
		$this->load->model("marina_chillan/Tipo_gratificacion_model");
		$this->load->model("marina_chillan/Descripcion_horarios_model");
		$base = array(
	...
	function eliminar_contratos_req_trabajador($id_usuario, $id_asc_area_req, $id_area_cargo_req, $id_req_usu_arch){
		...
		redirect('marina_chillan/requerimientos/contratos_req_trabajador/'.$id_usuario.'/'.$id_asc_area_req.'/'.$id_area_cargo_req.'', 'refresh');
	}
	...
	function guardar_nuevo_contrato_anexo_doc_contractual($usuario,$tipo,$asc_area){
		...
		redirect('marina_chillan/requerimientos/contratos_req_trabajador/'.$usuario.'/'.$asc_area.'/'.$id_area_cargo.'', 'refresh');
	}
	...
	function actualizar_contrato_anexo_doc_contractual($id_usu_arch,$id_area_cargo){
		$this->load->model("marina_chillan/Requerimiento_Usuario_Archivo_model");
		$this->load->model("marina_chillan/Descripcion_horarios_model");
		$this->load->model("marina_chillan/Descripcion_causal_model");
		$this->load->model('marina_chillan/Afp_model');
		$this->load->model('marina_chillan/Finiquitos_model');
		$this->load->model('marina_chillan/Usuarios_model');
		...
		if (isset($_POST['actualizar'])){
		    ...
		    $this->email->from('informaciones@empresasintegra.cl', 'Solicitud Contrato SGO - Marina Chillan');
		    ...
		    $this->email->send();
			echo '<script>alert("Solicitud de aprobacion de contrato a sido enviada exitosamente");</script>';
			//inicio de boton envio aprobacion de contrato
			...
			$template_formato = base_url()."extras/contratos/formatos_contratos_marina_chillan/formato_contrato.docx";
			...
			ob_clean();
			$templateWord->saveAs("extras/contratos/archivos_marina_chillan/".$nombre_documento);
			$get_url = "extras/contratos/archivos_marina_chillan/".$nombre_documento;
			...
			$template_formato = base_url()."extras/contratos/formatos_contratos_marina_chillan/formato_archivos_adicionales.docx";
			$templateWord = new TemplateProcessor($template_formato);
			$salto_linea = "<w:br/>";
			...
			$template_formato = base_url()."extras/contratos/formatos_contratos_marina_chillan/formato_finiquitos_diarios.docx";
			$templateWord = new TemplateProcessor($template_formato);
			$salto_linea = "<w:br/>";
			...
			$sueldo_liquido_27mil = isset($get_afp->sueldo_liquido_27mil)?$get_afp->sueldo_liquido_27mil:0;
			...
			$sueldo_liquido_38mil = isset($get_afp->sueldo_liquido_38mil)?$get_afp->sueldo_liquido_38mil:0;
			$sueldo_liquido_40mil = isset($get_afp->sueldo_liquido_40mil)?$get_afp->sueldo_liquido_40mil:0;
			$sueldo_liquido_44mil = isset($get_afp->sueldo_liquido_44mil)?$get_afp->sueldo_liquido_44mil:0;
			...
			$sueldo_liquido_60mil = isset($get_afp->sueldo_liquido_60mil)?$get_afp->sueldo_liquido_60mil:0;
			$sueldo_liquido_70mil = isset($get_afp->sueldo_liquido_70mil)?$get_afp->sueldo_liquido_70mil:0;
			...
			}elseif($renta_imponible == 27000){
				$renta_imponible = round($sueldo_liquido_27mil / 30);
			...
			}elseif($renta_imponible == 38000){
				$renta_imponible = round($sueldo_liquido_38mil / 30);
			}elseif($renta_imponible == 40000){
				$renta_imponible = round($sueldo_liquido_40mil / 30);
			}elseif($renta_imponible == 44000){
				$renta_imponible = round($sueldo_liquido_44mil / 30);
			...
			}elseif($renta_imponible == 60000){
				$renta_imponible = round($sueldo_liquido_60mil / 30);
			}elseif($renta_imponible == 70000){
				$renta_imponible = round($sueldo_liquido_70mil / 30);
			}else{
				$renta_imponible = 0;
			}
	...
	function eliminar_usuarios_req($id,$area_cargo){
		...
		redirect('marina_chillan/requerimientos/usuarios_requerimiento/'.$area_cargo, 'refresh');
	}
	...
	function eliminar($id){
		...
		redirect(base_url().'marina_chillan/requerimientos/listado', 'refresh');
	}
	...
	function descargar_puesta_disposicion($id){
		...
		if ($requerimientos->letraCausal== 'A') {
			...
			foreach ($ac as $key) {
				...
				$valorTotal[$i] = $subtotal[$i]+($subtotal[$i]*0.0163)+($subtotal[$i]*0.0153)+($subtotal[$i]*0.03);//$totalDiasRequerimiento Reemplazar por 1;
				$valorTotalRedondeado[$i] = round($valorTotal[$i]*$key->cantidadTrabajadores);
			...
			$template_formato = base_url()."extras/contratos/formatos_contrato_disposicion/formatoContratoPuestaDisposicionmarina_chillan.docx";
			$templateWord = new TemplateProcessor($template_formato);
