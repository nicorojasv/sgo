...
class Horarios extends CI_Controller{
	...
	function index(){
		$base = array(
			'head_titulo' => "Sistema EST - Listado de Horarios Marina Chillán",
			'titulo' => "Horarios Marina Chillán",
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url' => '', 'txt' => 'Horarios Marina Chillán')),
			'menu' => $this->menu,
	...
	function modal_editar($id){
		...
		$this->load->view('marina_chillan/horarios/modal_editar_horario', $pagina);
	}
	...
	function guardar_nuevo_horario(){
		...
		redirect('marina_chillan/horarios', 'refresh');
	}
