...
class Requerimiento_asc_trabajadores_model extends CI_Model{
	...
	function get($id){
		...
		$query = $this->marina_chillan->get('r_requerimiento_asc_trabajadores');
		return $query->row();
	}
	...
	function get_cargo_area($id){
		$this->marina_chillan->where('requerimiento_area_cargo_id',$id);
		$query = $this->marina_chillan->get('r_requerimiento_asc_trabajadores');
		return $query->result();
	}
	...
	function eliminar($id){
		$this->marina_chillan->delete('r_requerimiento_asc_trabajadores', array('id' => $id)); 
	}

	function editar($id,$data){
		$this->marina_chillan->where('id', $id);
		$this->marina_chillan->update('r_requerimiento_asc_trabajadores', $data); 
	}

	function ingresar($data){
		$this->marina_chillan->insert('r_requerimiento_asc_trabajadores',$data); 
