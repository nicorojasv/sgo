...
class Asistencia extends CI_Controller{
	public function __construct(){
		...
		$this->load->model("marina/Asistencia_model");
	...
	function index($fecha = false){
		...
		$base = array(
			...
			'subtitulo' => '<b>Unidad de Negocio:</b> marina',
			'side_bar' => true,
			'js' => array('plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/lista_usuarios_activos.js','plugins/bootstrap-datepicker/js/bootstrap-datepicker.js','js/exportarExcelmarina.js'),
	...
	function guardar_asistencia(){
		...
		redirect('marina/asistencia/index/'.$fechaTrabajando,'refresh');
	}
	...
	function listado_activo_personal($siVengoDesdeBono = false){//Listado Para activar personal  para el mes
		...
		$base = array(
			...
			'subtitulo' => '<b>Unidad de Negocio:</b> marina',
			'side_bar' => true,
			//'js' => array('tabla/stacktable.js','tabla/asistenciamarina.js'),
	...
	function guardar_estado_asistencia(){// guardando estado de los trabajadores activos
		...
		redirect('marina/asistencia/listado_activo_personal','refresh');
	}
	...
	function guardar_bono(){
		...
		$this->session->set_userdata('exito',1);
		redirect('marina/asistencia/bonos/'.$fechaTrabajando,'refresh');
	}
