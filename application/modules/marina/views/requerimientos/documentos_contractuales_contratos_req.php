<div class="panel panel-white">
	...
	<div class="panel-body">
		...
		<div class="col-md-4">
          	<a data-toggle="modal" href="<?php echo base_url() ?>marina/requerimientos/modal_agregar_contrato_anexo/<?php echo $id_usuario ?>/1/<?php echo $id_asc_area_req ?>/<?php echo $id_area_cargo_req ?>" data-target="#ModalEditar"><input type="button" class='btn btn-blue' value="Agregar Contrato"></a>
          	<a data-toggle="modal" href="<?php echo base_url() ?>marina/requerimientos/modal_agregar_contrato_anexo/<?php echo $id_usuario ?>/2/<?php echo $id_asc_area_req ?>/<?php echo $id_area_cargo_req ?>" data-target="#ModalEditar"><input type="button" class='btn btn-blue' value="Agregar Anexo"></a>
			<br><br>
		</div>
		<div class="col-md-12">
			<table id='example1'>
				...
				<tbody>
					<?php foreach ($contratos as $row) { ?>
						<tr>
    	                    ...
    	                    <td>
    	                    	<a data-toggle="modal" href="<?php echo base_url() ?>marina/requerimientos/modal_administrar_contrato_anexo_doc_general/<?php echo $row->id_req_usu_arch ?>/<?php echo $id_area_cargo_req ?>" data-target="#ModalEditar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
    	                    	<!--
								<a title="Eliminar Documento" class="eliminar" href="<?php echo base_url() ?>marina/requerimientos/eliminar_contratos_req_trabajador/<?php echo $id_usuario ?>/<?php echo $id_asc_area_req ?>/<?php echo $id_area_cargo_req ?>/<?php echo $row->id_req_usu_arch ?>"><i class="fa fa-trash-o"></i></a>
								-->
    	                    </td>
						</tr>
					<?php } ?>
