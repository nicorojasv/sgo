<div id="modal">
  ...
  <div id="modal_content">
    ...
    <form action="<?php echo base_url() ?>marina/requerimientos/actualizar_area_cargo_requerimiento" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" autocomplete="off">
      <?php
