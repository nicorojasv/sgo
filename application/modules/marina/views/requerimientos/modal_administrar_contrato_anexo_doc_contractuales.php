<div id="modal">
  <form action="<?php echo base_url() ?>marina/requerimientos/actualizar_contrato_anexo_doc_contractual/<?php echo $id_usu_arch?>/<?php echo $id_area_cargo?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" onsubmit ="return bloqEnvio()" >
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select class="form-control" name="renta_imponible" id="renta_imponible" <?php if($estado_bloqueo == "si") echo "disabled"; ?>>
              ...
              <option value="16000" <?php if($row->renta_imponible == "16000") echo "selected"; ?> >$16.000</option>
              ...
              <option value="17500" <?php if($row->renta_imponible == "17500") echo "selected"; ?> >$17.500</option>
               ...
               <option value="19000" <?php if($row->renta_imponible == "19000") echo "selected"; ?> >$19.000</option>
        ...
        <div class="col-md-6" style="text-align: center" id="blw">
          ...
          <?php if($rechazado == 1 && !empty($usu->comentarios))echo " <b>Observacion:</b> ".$usu->comentarios; ?>
            ...
            <?php
                ...
                ?>
                    <label>Puede ver el contrato vigente <a href="<?php echo base_url()?>marina/requerimientos/contratos_req_trabajador/<?php echo $key->idUsuario."/".$key->id."/".$key->idAreaCargo ?>">aquí</a></label>
                <?php      
                  }
                ?>
