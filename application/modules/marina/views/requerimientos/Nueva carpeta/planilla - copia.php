	...
	<div class="panel-body">
		<div class="row">
				...
				<div class="col-md-2" align="center">
					<a href="<?php echo base_url() ?>est/requerimiento/evaluacion_pgp/<?php echo $requerimiento->id ?>"><input type="button" class="btn btn-blue" value="Detalle Requerimiento"></a><br><br>
      			</div>
			</div>
		<table id="example1">
			<thead>
