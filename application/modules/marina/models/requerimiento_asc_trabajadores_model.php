...
class Requerimiento_asc_trabajadores_model extends CI_Model{
	...
	function get($id){
		...
		$query = $this->marina->get('r_requerimiento_asc_trabajadores');
		return $query->row();
	}
	...
	function get_cargo_area($id){
		$this->marina->where('requerimiento_area_cargo_id',$id);
		$query = $this->marina->get('r_requerimiento_asc_trabajadores');
		return $query->result();
	}
	...
	function eliminar($id){
		$this->marina->delete('r_requerimiento_asc_trabajadores', array('id' => $id)); 
	}

	function editar($id,$data){
		$this->marina->where('id', $id);
		$this->marina->update('r_requerimiento_asc_trabajadores', $data); 
	}

	function ingresar($data){
		$this->marina->insert('r_requerimiento_asc_trabajadores',$data); 
