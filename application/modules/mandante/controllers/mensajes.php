...
class Mensajes extends CI_Controller {
	...
	function index(){
		redirect('mandante/mensajes/bandeja/', 'refresh');
	}
	function bandeja() {
		$this->load->model("Mensajes_model");
		...
		$base['lugar'] = "Mensajes";
		$base['lugar_aux'] = "<a href='".base_url()."mandante/mensajes/crear' class='dialog tab'>Nuevo mensaje</a>";
	...
	function detalle($id) {
		...
		$base['titulo'] = "Mensajes";
		$base['lugar'] = "Mensajes";
		$base['lugar_aux'] = "<a href='".base_url()."mandante/mensajes/crear' class='tab dialog'>Nuevo mensaje</a>";
		$base['class_subheader'] = "toolbar";
	...
	function responder(){
		...
		redirect(base_url()."administracion/mensajes/detalle/".urlencode($this->encrypt->encode($_POST['id'])), 'refresh');
	}
