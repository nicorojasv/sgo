<div class="col-md-6 col-md-offset-2">
	...
	<table class='table'>
		<thead>
			<th class="center">Archivos Requerimientos</th>
					...
					<td class="center">
						<?php if( $a->datos ){ ?>
							<?php foreach($a->datos as $ar){ ?>
								<a href="<?php echo base_url().$ar->url ?>" target="_blank" style="color:green" ><?php echo $ar->nombre ?></a><br/>
							<?php } ?>
						<?php } else { ?>
	...
	<table class='table'>
		<thead>
			<th class="center">Archivos Trabajador</th>
			<th class="center">Estado</th>
		</thead>
		<tbody>
			<tr>
