...
class Asistencia extends CI_Controller{
	public function __construct(){
		...
		$this->load->model("sanatorio/Asistencia_model");
	...
	function guardar_asistencia(){
		...
		redirect('sanatorio/asistencia/index/'.$fechaTrabajando,'refresh');
	}
	...
	function guardar_estado_asistencia(){// guardando estado de los trabajadores activos
		...
		redirect('sanatorio/asistencia/listado_activo_personal','refresh');
	}
	...
	function guardar_bono(){
		...
		$this->session->set_userdata('exito',1);
		redirect('sanatorio/asistencia/bonos/'.$fechaTrabajando,'refresh');
	}
