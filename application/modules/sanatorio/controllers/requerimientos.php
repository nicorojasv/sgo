...
class Requerimientos extends CI_Controller {
	public function __construct(){
		...
		elseif( $this->session->userdata('tipo_usuario') == 14)
			$this->menu = $this->load->view('layout2.0/menus/sanatorio_menu_admin','',TRUE);
		elseif( $this->session->userdata('tipo_usuario') == 15)
			$this->menu = $this->load->view('layout2.0/menus/sanatorio_menu_admin_supervisor','',TRUE);
	...
	function index(){
		redirect('sanatorio/requerimientos/listado', 'refresh');
	}
	...
	function agregar(){
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'sanatorio/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Crear Requerimiento' )),
		...
		$this->load->model("sanatorio/Cargos_model");
		$this->load->model('sanatorio/Empresas_model');
		$this->load->model('sanatorio/Centrocostos_model');
		$this->load->model("sanatorio/Empresa_planta_model");
		//$this->load->model("sanatorio/Relacion_usuario_planta_model");
		$this->load->model('sanatorio/Requerimientos_model');
	...
	function asignacion($id){
		$this->load->model("sanatorio/Requerimiento_area_cargo_model");
		$this->load->model('sanatorio/Requerimientos_model');
		$this->load->model('sanatorio/Empresa_planta_model');
		$this->load->model('sanatorio/Areas_model');
		$this->load->model('sanatorio/Cargos_model');
		$this->load->model('sanatorio/Requerimiento_asc_trabajadores_model');
		...
		$base = array(
			...
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'sanatorio/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Asignar Areas - Cargos Requerimiento' )),
			'menu' => $this->menu
		);
		...
		$base['cuerpo'] = $this->load->view('sanatorio/requerimientos/asignar_area_cargo_requerimiento',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function guardar_area_cargo_req(){
		...
		redirect('sanatorio/requerimientos/asignacion/'.$id_req.'', 'refresh');
	}
	...
	function listado($fecha = false){
		$base = array(
			...
			'menu' => $this->menu,
			'js' => array('js/confirm.js','plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/lista_req.js','js/exportarExcelsanatorio.js'),
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css'),
		);
		...
		$base['cuerpo'] = $this->load->view('sanatorio/requerimientos/listado',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function usuarios_requerimiento($id_area_cargo = false, $id_usuario = FALSE){
		...
		$this->load->model("sanatorio/Requerimiento_Usuario_Archivo_model");
		$this->load->model("sanatorio/Requerimiento_asc_trabajadores_model");
		$this->load->model("sanatorio/Requerimiento_area_cargo_model");
		$this->load->model("sanatorio/Requerimientos_model");
		$this->load->model('sanatorio/Archivos_trab_model');
		$this->load->model('sanatorio/Empresas_model');
		$this->load->model("sanatorio/Evaluaciones_model");
		$this->load->model("sanatorio/Usuarios_model");
		$this->load->model('sanatorio/Planta_model');
		$this->load->model("sanatorio/Areas_model");
		$this->load->model("sanatorio/Cargos_model");
		$this->load->model("sanatorio/Empresa_planta_model");
		$this->load->model("sanatorio/Listanegra_model");
		$this->load->model("sanatorio/Solicitud_revision_examenes_model");
		...
		if( $this->session->userdata('cargo') == 9 and $this->session->userdata('centro_costo') == 7 and $this->session->userdata('departamento') == 2 and $this->session->userdata('sucursal') == 11){
			$base = array(
				'head_titulo' => "Sistema sanatorio",
				'titulo' => "Usuarios asignados",
				'subtitulo' => '',
				'side_bar' => false,
				'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'sanatorio/requerimiento/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Lista de usuarios' )),
				'menu' => $this->menu,
			...
			$base = array(
				...
				'subtitulo' => '',
				'side_bar' => false,
				'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'sanatorio/requerimiento/listado','txt' => 'Requerimientos'), array('url'=>'sanatorio/requerimiento/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Lista de usuarios' )),
				'menu' => $this->menu,
		...
		$pagina['agregados'] = $i;
		$base['cuerpo'] = $this->load->view('sanatorio/requerimientos/usuarios_requerimiento',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function usuarios_requerimientos_listado($id_area_cargo){
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'sanatorio/requerimientos/usuarios_requerimiento/'.$id_area_cargo."", 'txt'=>'Volver a la Area - Cargo del Requerimiento'), array('url'=>'','txt'=>"Listado Trabajadores requerimiento ".$this->Requerimientos_model->get($id_req)->nombre."" )),
			'menu' => $this->menu,
		...
		$base['cuerpo'] = $this->load->view('sanatorio/requerimientos/listado_usuarios_req',$pagina, TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function agregar_usuarios_requerimiento(){
		...
		redirect('sanatorio/requerimientos/usuarios_requerimiento/'.$id_area_cargo, 'refresh');
	}
	...
	function contratos_req_trabajador($id_usuario,$id_asc_area_req,$id_area_cargo_req = FALSE,$agregandoAnexo= FALSE){
		...
		$this->load->model("sanatorio/Requerimiento_area_cargo_model");
		$this->load->model("sanatorio/Usuarios_model");
		$this->load->model("sanatorio/ciudades_model");
		$this->load->model("sanatorio/Afp_model");
		$this->load->model("sanatorio/Salud_model");
		$this->load->model("sanatorio/estado_civil_model");
		$this->load->model("sanatorio/Requerimientos_model");
		$this->load->model("sanatorio/Nivel_estudios_model");
		$this->load->model("sanatorio/Areas_model");
		$this->load->model("sanatorio/Cargos_model");
		$this->load->model("sanatorio/Empresas_model");
		$this->load->model("sanatorio/Empresa_planta_model");
		$this->load->model("sanatorio/regiones_model");
		$this->load->model("sanatorio/Tipo_gratificacion_model");
		$this->load->model("sanatorio/Solicitud_revision_examenes_model");
		$this->load->model("sanatorio/Descripcion_horarios_model");
		...
		$base = array(
			...
			'lugar' => array(
							...
							array('url'=>'sanatorio/requerimientos/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), 
							array('url'=>'sanatorio/requerimientos/usuarios_requerimiento/'.$id_area_cargo_req,'txt'=>'Lista de usuarios' ), 
...
//18138050*/
		...
		$base['cuerpo'] = $this->load->view('sanatorio/requerimientos/documentos_contractuales_contratos_req',$pagina, TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function eliminar_contratos_req_trabajador($id_usuario, $id_asc_area_req, $id_area_cargo_req, $id_req_usu_arch){
		...
		redirect('sanatorio/requerimientos/contratos_req_trabajador/'.$id_usuario.'/'.$id_asc_area_req.'/'.$id_area_cargo_req.'', 'refresh');
	}
	...
	function modal_agregar_contrato_anexo($usuario,$tipo,$asc_area, $id_req_area_cargo){
		...
		$this->load->view('sanatorio/requerimientos/modal_agregar_contrato_anexo_doc_contractuales', $pagina);
	}
	...
	function guardar_nuevo_contrato_anexo_doc_contractual($usuario,$tipo,$asc_area){
		...
		redirect('sanatorio/requerimientos/contratos_req_trabajador/'.$usuario.'/'.$asc_area.'/'.$id_area_cargo.'', 'refresh');
	}
	...
	function modal_administrar_contrato_anexo_doc_general($id_usu_arch,$id_area_cargo){
		...
		$this->load->model("sanatorio/Solicitud_revision_examenes_model");
		$this->load->model("sanatorio/Descripcion_horarios_model");
		$this->load->model("sanatorio/Sre_evaluacion_req_model");
		...
		$this->load->view('sanatorio/requerimientos/modal_administrar_contrato_anexo_doc_contractuales', $pagina);
	}
	function qwea(){
		$fecha = 
	...
	function actualizar_contrato_anexo_doc_contractual($id_usu_arch,$id_area_cargo){
		$this->load->model("sanatorio/Requerimiento_Usuario_Archivo_model");
		$this->load->model("sanatorio/Descripcion_causal_model");
		$this->load->model("sanatorio/Descripcion_horarios_model");
		...
		if(isset($_POST['actualizar'])){
		    ...
		    $this->email->from('informaciones@empresasintegra.cl', 'Solicitud Contrato SGO - sanatorio');
		   ...
		   // $this->email->cc('jcruces@empresasintegra.cl');
			...
			if($jornada == "1"){
					$template_formato = base_url()."extras/contratos/formatos_contratos_sanatorio/2_contrato_sin_pacto_he.docx";
			}else{
					$template_formato = base_url()."extras/contratos/formatos_contratos_sanatorio/1_contrato_con_pacto_he.docx";
			}
			...
			$fecha_termino = $fecha_termino;
				...
				$template_formato = base_url()."extras/contratos/formatos_contratos_sanatorio/documentos_contractuales.docx";
	...
	function eliminar_usuarios_req($id,$area_cargo){
		...
		redirect('sanatorio/requerimientos/usuarios_requerimiento/'.$area_cargo, 'refresh');
	}
	...
	function eliminar($id){
		...
		redirect(base_url().'sanatorio/requerimientos/listado', 'refresh');
	}
...
function descargar_puesta_disposicion($id){
		...
		if ($requerimientos->letraCausal== 'A') {
			...
			$template_formato = base_url()."extras/contratos/formatos_contrato_disposicion/formatoContratoPuestaDisposicionsanatorio.docx";
			$templateWord = new TemplateProcessor($template_formato);
			$salto_linea = "<w:br/>";
	...
	function modal_agregar_anexo($usuario,$tipo,$asc_area, $id_req_area_cargo){
		...
		$pagina['datos_req'] = $datos_req;
		$pagina['tipo_jornada'] = $tipo_jornada;
		$this->load->view('sanatorio/requerimientos/modal_crear_anexo', $pagina);
	}
...
function descargar_carta_termino($id_usuario, $idArchivo, $tipoArchivo){
	...
	function modal_administrar_archivo_usu($id_req_usu_arch = FALSE, $id_area_req = FALSE){
		...
		$this->load->view('sanatorio/requerimientos/modal_administrar_doc_contractuales', $pagina);
	}
	...
	function callback_view_documentos($id_usuario,$id_asc_area_req,$id_req = FALSE){
		$this->load->model("sanatorio/tipoarchivos_requerimiento_model");
		$this->load->model("sanatorio/requerimiento_usuario_archivo_model");
		$this->load->model("sanatorio/Tipoarchivos_model");
		$this->load->model("sanatorio/Archivos_trab_model");
		$this->load->model("sanatorio/Usuarios_model");
		$this->load->model("sanatorio/Evaluaciones_model");
		$this->load->model("sanatorio/Requerimiento_area_cargo_model");
		$this->load->model("sanatorio/Pensiones_Requerimiento_model");
		$this->load->model("sanatorio/Pensiones_Valores_model");
		$this->load->model("sanatorio/Pensiones_model");
		$usr = $this->Usuarios_model->get($id_usuario);
		...
		$this->load->view('sanatorio/requerimientos/documentos_contractuales',$base);
	}
	function modal_administrar_anexo($idAnexo, $id_area_cargo){
		...
		$this->load->view('sanatorio/requerimientos/modal_administrar_anexo', $pagina);
	}
	...
	function enviar_revision($id= false){
		...
		if ($resultado == 1) {
			$this->load->library('email');
				...
				$config['smtp_port']    = '2552';
				$this->email->initialize($config);
			    $this->email->from('informaciones@empresasintegra.cl', 'Solicitud Anexo SGO - sanatorio');
			   // $this->email->to('nrojas@empresasintegra.cl');
			    $this->email->cc('jcruces@empresasintegra.cl');
	...
	//inicio de boton generar anexo
		...
		//var_dump($datos); return false;
		if ($datos->estado == 2) {
				$template_formato = base_url()."extras/contratos/anexos/anexosanatorio.docx";
				$templateWord = new TemplateProcessor($template_formato);
				$salto_linea = "<w:br/>";
...
function modal_cargar_anexo($idAnexo, $id_area_cargo= false){
		...
		$this->load->view('sanatorio/requerimientos/modal_subir_anexo', $pagina);
	}
	...
	function actualizar_anexo($id=false){
		...
		redirect('sanatorio/requerimientos/contratos_req_trabajador/'.$datosAnexoContrato->usuario_id.'/'.$datosAnexoContrato->requerimiento_asc_trabajadores_id.'/'.$datosAnexoContrato->id_requerimiento_area_cargo.'', 'refresh');
	}
}
