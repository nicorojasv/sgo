...
class Horarios extends CI_Controller{
	...
	function index(){
		$base = array(
			'head_titulo' => "Sistema EST - Listado de Horarios sanatorio",
			'titulo' => "Horarios sanatorio",
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url' => '', 'txt' => 'Horarios sanatorio')),
			'menu' => $this->menu,
		...
		$base['cuerpo'] = $this->load->view('sanatorio/horarios/listado',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}

	function modal_editar($id){
		$pagina['datos_horario'] = $this->Descripcion_horarios_model->get_result($id);
		$this->load->view('sanatorio/horarios/modal_editar_horario', $pagina);
	}
	...
	function guardar_nuevo_horario(){
		...
		redirect('sanatorio/horarios', 'refresh');
	}
