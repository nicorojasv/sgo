<div class="col-md-8 col-md-offset-2">
	<form class="form-horizontal" id="agregar_examen" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>est/evaluaciones/guardar_creacion_eval/<?php echo $id ?>/">
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select id="tipo" style="width: 244px;" name="evaluacion">
