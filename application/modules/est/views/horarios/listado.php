...
<div class="panel panel-white">
	<div class="panel-heading">
		<h4 class="panel-title">Listado de Horarios EST</h4>
	</div>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php if($l->id_tipo_horario == 1) echo "Administrativo"; elseif($l->id_tipo_horario == 2) echo "Turno u otros"; ?></td>
						<td><?php echo $l->nombre_horario; ?></td>
						<td><?php echo $l->descripcion; ?></td>
						<td class="center">
							<a data-toggle="modal" href="<?php echo base_url() ?>est/horarios/modal_editar/<?php echo $l->id_horario ?>" class="btn btn-xs btn-blue tooltips editar" data-target="#ModalEditar"><i class="fa fa-edit"></i></a>
							<a href="<?php echo base_url() ?>est/horarios/eliminar/<?php echo $l->id_horario ?>" class="btn btn-xs btn-red tooltips eliminar" data-placement="top" data-original-title="Eliminar"><i class="fa fa-times fa fa-white"></i></a>
						</td>
					</tr>
				<?php
					$i++;
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url() ?>est/horarios/guardar_nuevo_horario" method='post'>
					<div class="col-md-6">
							...
							<div class="controls">
								<select name="empresa_planta" id="empresa_planta" class="form-control" required>
									...
									<?php foreach($listado_empresas_planta as $ep){ ?>
	              					<option value="<?php echo $ep->id ?>"><?php echo $ep->nombre ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
					...
					<div class="col-md-6">
			            ...
			            <div class="controls">
			              <label for="tipo_horario_1"><input type="radio" name="tipo_horario" id="tipo_horario_1" value="1" checked> Administrativo </label>
			              <label for="tipo_horario_2"><input type="radio" name="tipo_horario" id="tipo_horario_2" value="2"> Turno u otros </label>
			            </div>
			          </div>
					</div>
					<div class="col-md-12">
