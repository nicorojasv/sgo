						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<input type="checkbox" name="examen_masso[<?php echo $i ?>]" id="examen_masso[<?php echo $i ?>]" <?php if($row->req_activos == 0) echo "disabled hidden"; ?> > <?php if($row->req_activos > 0) echo "Masso" ?><br>
									...
									<input type="checkbox" name="examen_psicologico[<?php echo $i ?>]" id="examen_psicologico[<?php echo $i ?>]" <?php if($row->req_activos == 0) echo "disabled hidden"; ?> > <?php if($row->req_activos > 0) echo "Ev. Psic" ?>
									<?php } ?>
								</td>
								...
								<td>
									<a title="Eliminar Solicitud" class="eliminar" href="<?php echo base_url() ?>est/trabajadores/eliminar_solicitud_previa_revision_examen/<?php echo $row->id_solicitud_previa ?>"><i class="fa fa-trash-o"></i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
