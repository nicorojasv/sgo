  ...
  <div class="panel-body">
      <div class="row" style="padding-left: 10px; margin-bottom: 10px;">
        <div class="col-md-10" style="border: 1px solid #ccc; padding-bottom: 10px;">
          <form action="<?php echo base_url() ?>est/trabajadores/contratos_y_anexos" method="post" id="FormularioGet">
          <label for="seleccion_planta"><h4>Planta: </h4></label>
            <select name="nombrePlantaSeleccionada" id="seleccion_planta">
            <option selected disabled value="">Selecione Planta</option>
            <option value="todasLasPlantas"<?php if(isset($plantaSeleccionada)){if($plantaSeleccionada == 'todasLasPlantas'){echo "selected";}} ?> >Todas las Plantas</option>
            <?php 
              foreach ($plantas as $key ){ 
            ?>
                  <option value="<?php echo $key->nombre?>"
                  <?php if(isset($plantaSeleccionada)){ 
                          if($plantaSeleccionada == $key->nombre){
                             echo "selected";} 
                          }?> >
                        <?php echo $key->nombre?>
                  </option>
            ...
            <br><br>
            <div id="tipoSeleccion" class="row" style=" <?php if(isset($inptradio)){echo "";}else{echo "display:none;";}?>padding:0;margin: 0;">
