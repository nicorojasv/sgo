<div id="modal">
  ...
  <div id="modal_content">
    ...
    ?>
      ...
      <form action="<?php echo base_url() ?>est/trabajadores/actualizar_datos_estado_examen_ps" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="col-md-6">
          <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="valor_examen" id="valor_examen" class="form-control" value="<?php echo $row->valor_examen ?>" required>
            </div>
          </div>
          <div class="control-group">
        ...
        <div class="col-md-6">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <textarea class="form-control" name="comentario_pago" required><?php echo $row->comentario_cobro ?></textarea>
            </div>
          </div>
        </div>
        <?php
