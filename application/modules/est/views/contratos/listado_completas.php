        ...
        <div class="row">
          ...
          <!--<div class="col-md-10">
            <select class="form-control" onchange="location = this.value">
              ...
              <label for="datepickerAraucoAdministrador">Mes A Consultar: </label>
              <input name="datepicker" type="text" id="datepickerAraucoAdministrador" style="border: 1px solid #ccc;" class="datepicker" value="<?php if(isset($mes)) echo $mes ?>" size="10" readonly="true" title="Fecha a Gestionar Asistencia"><br>
              <input style="cursor: pointer;"  type="radio" id="historico" name="historico" value="historico"<?php if($mes == 'historico')echo "checked" ?>  onclick="historicoAdministrador()" >
