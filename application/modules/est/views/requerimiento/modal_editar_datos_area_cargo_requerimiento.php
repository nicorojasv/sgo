...
<div id="modal">
  ...
  <div id="modal_content">
    ...
    <form action="<?php echo base_url() ?>est/requerimiento/actualizar_area_cargo_requerimiento" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" autocomplete="off">
      <?php
      ...
      <div class="col-md-8">
          ...
          <div class="col-md-1">
            ...
            <div class="control-group">
              <label class="control-label" for="inputTipo"><b>SUELDO BASE</b></label>
              <div class="controls">
                <input type="text" name="valor" id="valor" onkeyup="format(this)"  value="<?php echo $row->valor ?>" onkeypress='return valida_numeros(event)' maxlength='9' required>
              </div>
            </div>
          </div>
