...
<script>
    $(document).ready(function(){
       $(".chkbxCambio").click(function(){
          if ($('#chkbxCambio').is(':checked')) {
              $('#nuevoMotivo').show();
              $('#nuevoMotivo').focus();
          }else{
            $('#nuevoMotivo').hide();
...
<div id="modal">
  <form action="<?php echo base_url() ?>est/requerimiento/guardar_anexo/<?php echo $usuario?>/<?php echo $tipo?>/<?php echo $asc_area?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
  ...
  <div id="modal_content">
    ...
    ?>
        ...
        <div>
          ...
          <div class="control-form col-md-6">
            <?php 
              if ($causal_defecto == 'A') {
            ?>
              <label for="chkbxCambio">¿ Cambiar motivo de contratacion ?</label> <input type="checkbox" class="chkbxCambio" name="chkbxCambio" id="chkbxCambio" value="1">
              <div class="controls">
              <input type="text" style="display: none" class="form-control" name="nuevoMotivo" id="nuevoMotivo" >
           </div>
            <?php 
              }
            ?>
      ...
      <?php 
          ...
          $now = explode('-', $datos_req->fecha_termino2);
              $dia_fin = $now[2];
              $mes_fin = $now[1];
              $ano_fin = $now[0];
      ...
      ?>
        <label class="col-md-offset-2">No es posible crear Anexo,<br> trabajador se encuentra finiquitado con fecha: <?php echo $dia_fin." de ".$mes." del ".$ano_fin?></label>
      <?php 
          }
      ?>
    </div>
...
$(function () {
    $("#datepicker").datepicker({ duration: "slow"  });
    $("#datepicker2").datepicker({  duration: "slow" });
    $("#datepicker3").datepicker({   duration: "slow" });
});
</script>
