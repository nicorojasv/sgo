<div id="modal">
  ...
  <div id="modal_content">
    ...
    <form action="<?php echo base_url() ?>est/requerimiento/actualizar_requerimiento" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" autocomplete="off">
      <?php
        if ($listado != FALSE){
      ...
      ?>
            ...
            <div class="controls">
                <input type='text' class="input-mini form-control" name="codigo_centro_costo" id="causal" value="<?php echo $row->codigo_centro_costo ?>" required/>
            </div>
          </div>
        <div class="col-md-6">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <select name="select_planta" id="select_planta" class="form-control" required>
                <option value="<?php echo $row->planta_id ?>"><?php echo $row->nombre_planta ?></option>
          ...
          <div class="control-group">
            ...
            <div class="controls">
                  <select name="select_regimen" id="select_regimen" class="form-control" required>
                    <?php
                      if($row->regimen == "NL"){
                        $nombre_regimen = "Normal";
                      }elseif($row->regimen == "PGP"){
                        $nombre_regimen = "PGP";
                      }elseif ($row->regimen == "URG"){
                        $nombre_regimen = "URGENCIA";
                      }
                    ?>
                    <option value="<?php echo $row->regimen ?>"><?php echo $nombre_regimen ?></option>
        ...
        <div class="col-md-6">
          ...
          <div class="control-group">
            ...
            <div class="controls">
               <input type="text" name="f_fin" id="f_fin" class="form-control" value="<?php echo $row->f_fin ?>" readonly required>
            </div>
          </div>
          <div class="control-group">
