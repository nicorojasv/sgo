...
alertify.confirm('Hola <?php//echo $this->session->userdata('nombres');?>',pre, function(){
      ...
      var idPersona=1;
                     $.ajax({
                      type:"POST",
                      url: base_url+"est/requerimiento/no_mostrar_notificacion",
                      data:idPersona,
                      dataType: "json",
                      success:function(data){
                        if (data== true) {
...
<div id="modal">
  <form id="form2"   @submit="checkForm" action="<?php echo base_url() ?>est/requerimiento/guardar_nuevo_contrato_anexo_doc_contractual/<?php echo $usuario?>/<?php echo $tipo?>/<?php echo $asc_area?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
