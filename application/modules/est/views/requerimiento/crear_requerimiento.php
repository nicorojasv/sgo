<div class="panel panel-white" >
	...
	<div class="panel-body">
		<form action="<?php echo base_url() ?>est/requerimiento/guardar_datos_requerimiento" class="smart-wizard form-horizontal" role="form" id="form" method='post' name="formulario">
				...
				<div class="stepContainer" style="height: 353px;">
					...
					<div id="step-1" class="content" style="display: block;">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" name="codigo_requerimiento" class="form-control" value="<?php echo $ultimo_folio ?>" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">
						...
						<div class="form-group">
							...
							<div class="col-sm-7" >
								<div class="input-group">
									<input type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" name="f_solicitud" class="form-control date-picker" autocomplete="off" required>
								...
								<div class="row">
									<div class="col-md-12">
										<select name="select_regimen" id="select_regimen" class="form-control" required>
											<option value="">Seleccion Regimen</option>
								...
								<div class="row">
									<div class="col-md-12">
										<select name="select_planta" id="select_planta" class="form-control" required>
											<option value="">Seleccion Planta</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-7" >
								 <select name="causal" id="causal" class="form-control" required >
					                <option value="" selected disabled>Seleccion Causal</option>
					...
					<div id="step-2" class="content" style="display: none;">
						<h4 class="StepTitle">Asignaci&oacute;n de areas,cargos y cantidad de usuarios</h4>
						<div class="form-group">
						</div>
					</div>
				</div>
