   ...
   $('#agregarContrato').attr('disabled','disabled')
    ...
    $(document).ready(function(){
      ...
      <?php 
       ...
       ?>
<div id="modal">
  <form action="<?php echo base_url() ?>est/requerimiento/actualizar_anexo/<?php echo $anexos->id ?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
  ...
  <div id="modal_content">
          ...
          <div class="control-form col-md-10">
            ...
            <div class="clearfix"></div>
                 <?php 
                  if($motivo){
                    echo "Nuevo Motivo :".$motivo->motivo;
                  }
                  ?>
