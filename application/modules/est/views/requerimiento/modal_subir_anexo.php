...
<div id="modal">
  <form action="<?php echo base_url() ?>est/requerimiento/subir_anexo/<?php echo $datosAnexo->id ?>/<?php echo  $datosAnexo->id_requerimiento_area_cargo ?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
