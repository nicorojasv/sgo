<div class="panel panel-white">
	...
	<div class="panel-body">
		<div class="col-md-5">
              ...
              <label for="datepickerEnjoyRequerimientos">Mes A Consultar: </label>
              <input name="datepicker" type="text" id="datepickerEnjoyRequerimientos" style="border: 1px solid #ccc;" class="datepicker" value="<?php if(isset($mes)) echo $mes ?>" size="10" readonly="true" title="Fecha a Gestionar Asistencia"><br>
		...
		<div class="col-md-2">
			<a href="<?php echo  base_url() ?>enjoy/requerimientos/agregar" class="btn btn-blue btn-block" target="_blank">Agregar</a>
		</div>
		<br><br><br>
		<?php if( count($listado) > 0){ ?>
  		<form action="<?php echo base_url() ?>enjoy/requerimientos/cambiar_estados_requerimientos" method='post'>
			<table id="example1">
				<thead>
					<tr>
						<th>Nombre</th>
				...
				<tbody>
					...
					<tr class="odd gradeX">
						...
						<td style="width:47px; text-align:center">
							<a title="Asignar Areas-Cargos al Requerimiento" href="<?php echo base_url() ?>enjoy/requerimientos/asignacion/<?php echo $r->id ?>"><i class="fa fa-cogs" aria-hidden="true"></i></a>
							<a title="Editar datos Requerimiento" data-target="#ModalEditar" data-toggle="modal" href="<?php echo base_url() ?>enjoy/requerimientos/editar_requerimiento/<?php echo $r->id ?>"><i class="fa fa-pencil fa-fw"></i></a>
							<!--
							<a title="Eliminar Requerimiento" class="eliminar" href="<?php echo base_url() ?>enjoy/requerimientos/eliminar/<?php echo $r->id ?>"><i class="fa fa-trash-o"></i></a>

							-->
						
							<a href="<?php echo base_url() ?>enjoy/requerimientos/descargar_puesta_disposicion/<?php echo $r->id ?>"><i class="fa fa-download" aria-hidden="true"></i></a>
