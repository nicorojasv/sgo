<div id="modal">
  <form action="<?php echo base_url() ?>enjoy/requerimientos/actualizar_contrato_anexo_doc_contractual/<?php echo $id_usu_arch?>/<?php echo $id_area_cargo?>" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" onsubmit ="return bloqEnvio()" >
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select name="mes_ft" id="mes_ft" style="width: 33%;" <?php if($estado_bloqueo == "si") echo "disabled"; ?> >
              <option selected disabled value="">Mes</option>
              <option value='01' <?php if($bloqear!=false){if($mes_ft>'01'){echo '';}} echo ($mes_ft == '1')? "selected='selected'" : '' ?>>Enero</option>
              <option value='02' <?php if($bloqear!=false){if($mes_ft>'02'){echo '';}} echo ($mes_ft == '2')? "selected='selected'" : '' ?>>Febrero</option>
              <option value='03' <?php if($bloqear!=false){if($mes_ft>'03'){echo '';}} echo ($mes_ft == '3')? "selected='selected'" : '' ?>>Marzo</option>
              <option value='04' <?php if($bloqear!=false){if($mes_ft>'04'){echo '';}} echo ($mes_ft == '4')? "selected='selected'" : '' ?>>Abril</option>
              <option value='05' <?php if($bloqear!=false){if($mes_ft>'05'){echo '';}} echo ($mes_ft == '5')? "selected='selected'" : '' ?>>Mayo</option>
              <option value='06' <?php if($bloqear!=false){if($mes_ft>'06'){echo '';}} echo ($mes_ft == '6')? "selected='selected'" : '' ?>>Junio</option>
              <option value='07' <?php if($bloqear!=false){if($mes_ft>'07'){echo '';}} echo ($mes_ft == '7')? "selected='selected'" : '' ?>>Julio</option>
              <option value='08' <?php if($bloqear!=false){if($mes_ft>'08'){echo '';}} echo ($mes_ft == '8')? "selected='selected'" : '' ?>>Agosto</option>
              <option value='09' <?php if($bloqear!=false){if($mes_ft>'09'){echo '';}} echo ($mes_ft == '9')? "selected='selected'" : '' ?>>Septiembre</option>
              <option value='10' <?php if($bloqear!=false){if($mes_ft>'10'){echo '';}} echo ($mes_ft == '10')? "selected='selected'" : '' ?>>Octubre</option>
              <option value='11' <?php if($bloqear!=false){if($mes_ft>'11'){echo '';}} echo ($mes_ft == '11')? "selected='selected'" : '' ?>>Noviembre</option>
              <option value='12' <?php if($bloqear!=false){if($mes_ft>'12'){echo '';}} echo ($mes_ft == '12')? "selected='selected'" : '' ?>>Diciembre</option>
            </select>
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select name="mes_fp" id="mes_fp" style="width: 33%;" <?php if($estado_bloqueo == "si") echo "disabled"; ?> >
              ...
              ?>
              <option selected disabled value="">Mes</option>
              <option value='01' <?php if($bloqear!=false){if($mes_fp>'01'){echo '';}} echo ($mes_fp == '1')? "selected='selected'" : '' ?>>Enero</option>
              <option value='02' <?php if($bloqear!=false){if($mes_fp>'02'){echo '';}} echo ($mes_fp == '2')? "selected='selected'" : '' ?>>Febrero</option>
              <option value='03' <?php if($bloqear!=false){if($mes_fp>'03'){echo '';}} echo ($mes_fp == '3')? "selected='selected'" : '' ?>>Marzo</option>
              <option value='04' <?php if($bloqear!=false){if($mes_fp>'04'){echo '';}} echo ($mes_fp == '4')? "selected='selected'" : '' ?>>Abril</option>
              <option value='05' <?php if($bloqear!=false){if($mes_fp>'05'){echo '';}} echo ($mes_fp == '5')? "selected='selected'" : '' ?>>Mayo</option>
              <option value='06' <?php if($bloqear!=false){if($mes_fp>'06'){echo '';}} echo ($mes_fp == '6')? "selected='selected'" : '' ?>>Junio</option>
              <option value='07' <?php if($bloqear!=false){if($mes_fp>'07'){echo '';}} echo ($mes_fp == '7')? "selected='selected'" : '' ?>>Julio</option>
              <option value='08' <?php if($bloqear!=false){if($mes_fp>'08'){echo '';}} echo ($mes_fp == '8')? "selected='selected'" : '' ?>>Agosto</option>
              <option value='09' <?php if($bloqear!=false){if($mes_fp>'09'){echo '';}} echo ($mes_fp == '9')? "selected='selected'" : '' ?>>Septiembre</option>
              <option value='10' <?php if($bloqear!=false){if($mes_fp>'10'){echo '';}} echo ($mes_fp == '10')? "selected='selected'" : '' ?>>Octubre</option>
              <option value='11' <?php if($bloqear!=false){if($mes_fp>'11'){echo '';}} echo ($mes_fp == '11')? "selected='selected'" : '' ?>>Noviembre</option>
              <option value='12' <?php if($bloqear!=false){if($mes_fp>'12'){echo '';}} echo ($mes_fp == '12')? "selected='selected'" : '' ?>>Diciembre</option>
            </select>
        ...
        <div class="control-form">
          ...
          <div class="controls">
            ...
            <select class="form-control" name="renta_imponible" id="renta_imponible" <?php if($estado_bloqueo == "si") echo "disabled"; ?>>
              ...
              <option value="37000" <?php if($row->renta_imponible == "37000") echo "selected"; ?> >$37.000</option>
              <option value="40000" <?php if($row->renta_imponible == "40000") echo "selected"; ?> >$40.000</option>
              <option value="42000" <?php if($row->renta_imponible == "42000") echo "selected"; ?> >$42.000</option>
        ...
        <div class="col-md-6" style="text-align: center" id="blw">
          ...
          <?php if($rechazado == 1 && !empty($usu->comentarios))echo " <b>Observacion:</b> ".$usu->comentarios; ?>
            ...
            <?php
                ...
                ?>
                    <label>Puede ver el contrato vigente <a href="<?php echo base_url()?>enjoy/requerimientos/contratos_req_trabajador/<?php echo $key->idUsuario."/".$key->id."/".$key->idAreaCargo ?>">aquí</a></label>
                <?php      
                  }
                ?>
