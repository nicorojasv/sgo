...
class Requerimiento_asc_trabajadores_model extends CI_Model{
	...
	function get($id){
		...
		$query = $this->enjoy->get('r_requerimiento_asc_trabajadores');
		return $query->row();
	}
	...
	function get_cargo_area($id){
		$this->enjoy->where('requerimiento_area_cargo_id',$id);
		$query = $this->enjoy->get('r_requerimiento_asc_trabajadores');
		return $query->result();
	}
	...
	function eliminar($id){
		$this->enjoy->delete('r_requerimiento_asc_trabajadores', array('id' => $id)); 
	}

	function editar($id,$data){
		$this->enjoy->where('id', $id);
		$this->enjoy->update('r_requerimiento_asc_trabajadores', $data); 
	}

	function ingresar($data){
		$this->enjoy->insert('r_requerimiento_asc_trabajadores',$data); 
