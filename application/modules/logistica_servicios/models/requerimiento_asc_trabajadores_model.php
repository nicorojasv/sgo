...
class Requerimiento_asc_trabajadores_model extends CI_Model{
	...
	function get($id){
		...
		$query = $this->log_serv->get('r_requerimiento_asc_trabajadores');
		return $query->row();
	}
	...
	function get_cargo_area($id){
		$this->log_serv->where('requerimiento_area_cargo_id',$id);
		$query = $this->log_serv->get('r_requerimiento_asc_trabajadores');
		return $query->result();
	}
	...
	function eliminar($id){
		$this->log_serv->delete('r_requerimiento_asc_trabajadores', array('id' => $id)); 
	}

	function editar($id,$data){
		$this->log_serv->where('id', $id);
		$this->log_serv->update('r_requerimiento_asc_trabajadores', $data); 
	}

	function ingresar($data){
		$this->log_serv->insert('r_requerimiento_asc_trabajadores',$data); 
