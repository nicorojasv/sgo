...
class Trabajadores extends CI_Controller{
	...
	function crear(){
		...
		$this->load->model("logistica_servicios/Usu_parentesco_model");
		$this->load->model("logistica_servicios/Profesiones_model");
		...
		$base = array(
			...
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'logistica_servicios/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Crear Trabajador')),
		...
		$base['cuerpo'] = $this->load->view('logistica_servicios/trabajadores/crear_trabajador',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function detalle($id){
		...
		$base = array(
			...
			'subtitulo' => 'Unidad de Negocio: Celulosa Nueva Aldea',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'logistica_servicios/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Datos Trabajador')),
			'js' => array('js/jquery.Rut.min.js','js/usuarios.js', 'js/confirm.js', 'plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/ui-subview.js','plugins/select2/select2.min.js','js/si_validaciones.js'),
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css','plugins/select2/select2.css'),
			'menu' => $this->menu
		);
		...
		$base['cuerpo'] = $this->load->view('logistica_servicios/trabajadores/detalle',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function eliminar_trabajador($id_usuario){
		...
		redirect('logistica_servicios/trabajadores', 'refresh');
	}
	...
	function guardar_nuevo_trabajador(){
		...
		redirect('logistica_servicios/trabajadores/detalle/'.$id_usuario.'#datos-personales', 'refresh');
	}
	...
	function guardar_datos_de_emergencia(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('logistica_servicios/trabajadores/detalle/'.$id_usuario.'#contacto-emergencia', 'refresh');
	}
	...
	function guardar_tecnicos(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('logistica_servicios/trabajadores/detalle/'.$id_usuario.'#datos-tecnicos', 'refresh');
	}
	...
	function guardar_extra(){
		...
		$id_usuario = $_POST['id'];
		$banco = isset($_POST['select_bancos'])?$_POST['select_bancos']:'';
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('logistica_servicios/trabajadores/detalle/'.$id_usuario.'#datos-extras', 'refresh');
	}

	function contratos_y_anexos(){
		$this->load->model("logistica_servicios/Usuarios_model");
		$base = array(
			'head_titulo' => "EST - Contratos y Anexos",
			'titulo' => "Empresa: Blue",
		...
		$base['cuerpo'] = $this->load->view('logistica_servicios/trabajadores/base_datos_contratos_y_anexos',$pagina,TRUE);
	 	$this->load->view('layout2.0/layout',$base);
	}
