          ...
          <table id="example1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo base_url() ?>logistica_servicios/contratos/validar_contrato_anexo_doc/<?php echo $rm->id_req_usu_arch ?>" title="Aprobar solicitud" ><i class="fa fa-check hvr-pulse" aria-hidden="true"></i></a>-
                  <a href="<?php echo base_url() ?>logistica_servicios/contratos/rechazar_contrato/<?php echo $rm->id_req_usu_arch ?>"  title="Rechazar Solicitud" class="hvr-icon-spin"  ><i  class="fa fa-times hvr-icon " aria-hidden="true"></i></a>
