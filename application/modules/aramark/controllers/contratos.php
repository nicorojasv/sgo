	...
	function generar_contrato_anexo_doc_contractual(){
		...
		if (isset($_POST['dar_de_baja'])) { //para dar de baja un contrato
			...
			$nombre_trabajador = $nombre." ".$aP." ".$aM;
				...
				$this->email->cc($destinatarios_cc);
			    $this->email->subject("Baja de Contrato aramark Trabajador: ".$nombre_trabajador." APROBADA ");
			    $this->email->message('Estimado(a),<br> Solicitud de baja de contrato Aprobada.  <br>Saludos');
			    $this->email->send();
			redirect('aramark/contratos/solicitudes_pendientes_baja','refresh');
			return false;
	...
	function solicitud_bajar_contrato($id_usu_arch){
		if($id_usu_arch != FALSE ){
			...
			$hoy = date('Y-m-d');
			    ...
			    $this->email->subject("Baja de Contrato aramark Trabajador: ".$nombre_trabajador." fecha: ".$hoy." PENDIENTE ");
		...
		//redirect('aramark/contratos/solicitudes_completas','refresh');*/
