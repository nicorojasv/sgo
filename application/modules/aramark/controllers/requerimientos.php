...
class Requerimientos extends CI_Controller {
	...
	function index(){
		redirect('aramark/requerimientos/listado', 'refresh');
	}
	...
	function agregar(){
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Crear Requerimiento' )),
	...
	function asignacion($id){
		...
		$base = array(
			...
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'','txt'=>'Asignar Areas - Cargos Requerimiento' )),
			'menu' => $this->menu
		);
	...
	function guardar_area_cargo_req(){
		...
		redirect('aramark/requerimientos/asignacion/'.$id_req.'', 'refresh');
	}
	...
	function usuarios_requerimiento($id_area_cargo, $id_usuario = FALSE){
		...
		$this->load->model("aramark/Requerimiento_area_cargo_model");
		$this->load->model("aramark/Requerimientos_model");
		$this->load->model('aramark/Archivos_trab_model');
		$this->load->model('aramark/Empresas_model');
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => false,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'aramark/requerimientos/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Listado de usuarios' )),
			'menu' => $this->menu,
	...
	function usuarios_requerimientos_listado($id_area_cargo){
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/requerimientos/usuarios_requerimiento/'.$id_area_cargo."", 'txt'=>'Volver a la Area - Cargo del Requerimiento'), array('url'=>'','txt'=>"Listado Trabajadores requerimiento ".$this->Requerimientos_model->get($id_req)->nombre."" )),
			'menu' => $this->menu,
	...
	function agregar_usuarios_requerimiento(){
		...
		redirect('aramark/requerimientos/usuarios_requerimiento/'.$id_area_cargo, 'refresh');
	}
	...
	function contratos_req_trabajador($id_usuario,$id_asc_area_req,$id_area_cargo_req = FALSE){
		...
		$this->load->model("aramark/Tipo_gratificacion_model");
	...
	function eliminar_contratos_req_trabajador($id_usuario, $id_asc_area_req, $id_area_cargo_req, $id_req_usu_arch){
		...
		redirect('aramark/requerimientos/contratos_req_trabajador/'.$id_usuario.'/'.$id_asc_area_req.'/'.$id_area_cargo_req.'', 'refresh');
	}
	...
	function guardar_nuevo_contrato_anexo_doc_contractual($usuario,$tipo,$asc_area){
		...
		redirect('aramark/requerimientos/contratos_req_trabajador/'.$usuario.'/'.$asc_area.'/'.$id_area_cargo.'', 'refresh');
	}
	...
	function eliminar_usuarios_req($id,$area_cargo){
		...
		redirect('aramark/requerimientos/usuarios_requerimiento/'.$area_cargo, 'refresh');
	}
	...
	function eliminar($id){
		...
		redirect(base_url().'aramark/requerimientos/listado', 'refresh');
	}
