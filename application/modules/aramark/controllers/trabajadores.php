...
class Trabajadores extends CI_Controller{
	...
	function index(){
		...
		$base = array(
			...
			'subtitulo' => '<b>Unidad de Negocio:</b> Aramark',
			'side_bar' => true,
			'js' => array('js/confirm.js','plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/lista_usuarios_activos.js','js/exportarExcelaramark.js'),
	...
	function crear(){
		...
		$this->load->model("aramark/Usu_parentesco_model");
		$this->load->model("aramark/Profesiones_model");
		...
		$base = array(
			...
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Crear Trabajador')),
		...
		$base['cuerpo'] = $this->load->view('aramark/trabajadores/crear_trabajador',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function detalle($id){
		...
		$base = array(
			...
			'subtitulo' => 'Unidad de Negocio: Celulosa Nueva Aldea',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Datos Trabajador')),
			'js' => array('js/jquery.Rut.min.js','js/usuarios.js', 'js/confirm.js', 'plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/ui-subview.js','plugins/select2/select2.min.js','js/si_validaciones.js'),
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css','plugins/select2/select2.css'),
			'menu' => $this->menu
		);
		...
		$base['cuerpo'] = $this->load->view('aramark/trabajadores/detalle',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function eliminar_trabajador($id_usuario){
		...
		redirect('aramark/trabajadores', 'refresh');
	}
	...
	function guardar_nuevo_trabajador(){
		...
		redirect('aramark/trabajadores/detalle/'.$id_usuario.'#datos-personales', 'refresh');
	}
	...
	function guardar_datos_de_emergencia(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('aramark/trabajadores/detalle/'.$id_usuario.'#contacto-emergencia', 'refresh');
	}
	...
	function guardar_tecnicos(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('aramark/trabajadores/detalle/'.$id_usuario.'#datos-tecnicos', 'refresh');
	}
	...
	function guardar_extra(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('aramark/trabajadores/detalle/'.$id_usuario.'#datos-extras', 'refresh');
	}

		function contratos_y_anexos(){
		$this->load->model("aramark/Usuarios_model");
		$base = array(
			'head_titulo' => "EST aramark",
			'titulo' => "Empresas: aramark",
		...
		$base['cuerpo'] = $this->load->view('aramark/trabajadores/base_datos_contratos_y_anexos',$pagina,TRUE);
	 	$this->load->view('layout2.0/layout',$base);
	}
...
/*	function exportar_excel_contratos_y_anexos(){
	...
	function anotaciones($id){
		...
		$base = array(
			...
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css'),
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'aramark/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Anotaciones')),
			'menu' => $this->menu
		);
		$pagina ="";
	...
	function guardar_anotacion($id){
		...
		redirect('aramark/trabajadores/anotaciones/'.$id, 'refresh');
	}
	...
	function eliminar_anotacion($id_usuario,$id_anotacion){
		...
		redirect('aramark/trabajadores/anotaciones/'.$id_usuario, 'refresh');
	}
	/*END Lista Negra*/
}
?>