      ...
      <div class="row">
        ...
        <?php if (!isset($completa_baja)) { ?>
          <div class="col-md-8" align="left">
              <label for="datepickeraramarkSCompletas">Mes A Consultar: </label>
              <input name="datepicker" type="text" id="datepickeraramarkSCompletas" style="border: 1px solid #ccc;" class="datepicker" value="<?php if(isset($mes)) echo $mes ?>" size="10" readonly="true" title="Fecha a Gestionar Asistencia"><br>
      ...
      <label for="historico" style="cursor: pointer;" >Historico</label>
        ...
        <?php }?>
          <div class="col-md-4" align="center">
            <form action="<?php echo base_url() ?>aramark/contratos/exportar_excel_contratos_y_anexos" method="post" target="_blank" id="FormularioExportacion">
              <input title="EXPORTAR DATOS A ARCHIVO EXCEL" type="submit" class="botonExcelaramark btn btn-success btn-block" value="Exportar a Excel"><br>
            ...
            <tbody>
              ...
              <tr id="<?php echo $i ?>">
                ...
                <td>
                 ...
                 <!-- <a href="<?php echo base_url() ?>aramark/contratos/solicitud_bajar_contrato/<?php echo $rm->id_req_usu_arch ?>" title="Solicitar baja contrato" onClick="if(confirm('¿Esta seguro de dar de baja este contrato ?')) return true; else return false;"><i class="fa fa-sign-out" style="color: red" aria-hidden="true"></i></a>-->
        ...
        var idQuitar = $(this).attr('data-quitar');
          alertify.prompt('Baja de Contrato',"Contrato de "+nombre+".<br><br>Especifique motivo de solicitud de baja.", "",
            function(evt, value ){// si presiona ok hacer esto
              $.ajax({
                  type: "POST",
                  url: base_url+"aramark/contratos/solicitud_bajar_contrato/"+service,
