<div class="panel panel-white" >
	...
	<div class="panel-body">
		<form action="<?php echo base_url() ?>aramark/requerimientos/guardar_datos_requerimiento" class="smart-wizard form-horizontal" role="form" id="form" method='post' name="formulario">
