<div class="panel panel-white">
	...
	<div class="panel-body">
		...
		<div class="col-md-2">
			<a href="<?php echo  base_url() ?>aramark/requerimientos/agregar" class="btn btn-blue btn-block" target="_blank">Agregar</a>
		</div>
		<br><br><br>
		<?php if( count($listado) > 0){ ?>
  		<form action="<?php echo base_url() ?>aramark/requerimientos/cambiar_estados_requerimientos" method='post'>
			<table id="example1">
				<thead>
					<tr>
						<th>Nombre</th>
				...
				<tbody>
					...
					<tr class="odd gradeX">
						...
						<td style="width:47px; text-align:center">
							<a title="Asignar Areas-Cargos al Requerimiento" href="<?php echo base_url() ?>aramark/requerimientos/asignacion/<?php echo $r->id ?>"><i class="fa fa-cogs" aria-hidden="true"></i></a>
							<a title="Editar datos Requerimiento" data-target="#ModalEditar" data-toggle="modal" href="<?php echo base_url() ?>aramark/requerimientos/editar_requerimiento/<?php echo $r->id ?>"><i class="fa fa-pencil fa-fw"></i></a>
							<!--
							<a title="Eliminar Requerimiento" class="eliminar" href="<?php echo base_url() ?>aramark/requerimientos/eliminar/<?php echo $r->id ?>"><i class="fa fa-trash-o"></i></a>
							-->
						</td>
					</tr>
					<?php } ?>
