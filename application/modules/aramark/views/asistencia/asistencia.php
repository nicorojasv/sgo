...
<br>
  <div class="col-md-8">
       ...
       <input name="datepicker" type="text" id="datepickerAsistenciaAramark" style="border: 1px solid #ccc;" class="datepicker" value="<?php echo $fecha_mostrar ?>" size="10" readonly="true" title="Fecha a Gestionar Asistencia">
  </div>
  <div class="col-md-2">
     <a href="<?php echo base_url() ?>aramark/asistencia/listado_activo_personal" class="btn btn-col btn-primary">Listado de Personal</a>
  </div>
    <div class="col-md-2" align="center">
          <form action="<?php echo base_url() ?>aramark/asistencia/exportar_excel_bono_anticipo" method="post" target="_blank" id="FormularioExportacionAsistencia">
            <input title="EXPORTAR DATOS A ARCHIVO EXCEL" type="submit" class="botonExcelaramarkAsistencia btn btn-info btn-block" value="Exportar"><br>
  ...
  ?>
       <form action="<?php echo base_url() ?>aramark/asistencia/guardar_asistencia" method="post" role="form" enctype="multipart/form-data"><br>
