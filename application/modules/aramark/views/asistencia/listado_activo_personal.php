...
<br>
		<?php 
			if ($volverBono) {
		?>
			<a href="<?php echo base_url() ?>aramark/asistencia/bonos"  class="btn  btn-row btn-default">volver</a>

		<?php 
			}else{
		?>
				<a href="<?php echo base_url() ?>aramark/asistencia"  class="btn  btn-row btn-default">volver</a>
		<?php 
			}
		?>
</div>
	<form action="<?php echo base_url() ?>aramark/asistencia/guardar_estado_asistencia" method="post" role="form" enctype="multipart/form-data">
