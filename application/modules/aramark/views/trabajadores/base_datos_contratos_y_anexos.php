  ...
  <div class="panel-body">
      <div class="row" style="padding-left: 10px; margin-bottom: 10px;">
        <div class="col-md-10" style="border: 1px solid #ccc; padding-bottom: 10px;">
          <form action="<?php echo base_url() ?>aramark/trabajadores/contratos_y_anexos" method="post" id="FormularioGet">
          <label for="seleccion_planta"><h4>Planta: </h4></label>
            <select name="nombrePlantaSeleccionada" id="seleccion_planta">
            
            <option value="todasLasPlantas"<?php if(isset($plantaSeleccionada)){if($plantaSeleccionada == 'todasLasPlantas'){echo "selected";}} ?> >aramark </option>
