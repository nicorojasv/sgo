		...
		<div class="tabbable tabs-left">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="datos-personales">
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>aramark/trabajadores/guardar_personales" method="post" >
				...
				<div class="tab-pane fade" id="contacto-emergencia" >
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>aramark/trabajadores/guardar_datos_de_emergencia/<?php echo $id_usuario ?>" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-tecnicos">
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>aramark/trabajadores/guardar_tecnicos" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-extras">
					<h2>Datos Extras</h2>
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>aramark/trabajadores/guardar_extra" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
