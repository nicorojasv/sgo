		...
		<div class="tabbable tabs-left">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="datos-personales">
					...
					<form id="app"   @submit="checkForm" class="form-horizontal" action="<?php echo base_url()?>terramar/trabajadores/guardar_nuevo_trabajador" method="post" >
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" v-model="rut" name="rut" id="rut" data-submit="crear_trabajador" type="text" maxlength="12" onkeypress="return soloRUT(event)" onblur="checkRutGenerico(this, false, 2)" onfocus="limpiaPuntoGuion(this,2)" onpaste="return false" ondrag="return false" ondrop="return false" oncopy="return false" oncut="return false" autocomplete="off">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text"  v-model="nombres" name="nombres" value="" id="nombres" class="form-control" autocomplete="off" >
							</div>
						</div>
						<div class="form-group ">
							<label class="col-sm-2 control-label">
							...
							<div class="col-sm-9">
								<input type="text" v-model="paterno"  class="form-control" id="lastname" name="paterno" value="" autocomplete="off" >
							</div>
						</div>
						<div class="form-group ">
							<label class="col-sm-2 control-label">
							...
							<div class="col-sm-9">
								<input type="text" v-model="materno"  class="form-control" id="lastnamem" name="materno" value="" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" v-model="direccion" name="direccion" id="direccion" value="" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="fono1" name='fono1' value="" class="form-control"  autocomplete="off">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="fono2" name='fono3' value="" class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email" v-model="email" name="email" id="email" value="" class="form-control">
							</div>
						</div>
						<div class="form-group">
