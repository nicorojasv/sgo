		...
		<div class="tabbable tabs-left">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="datos-personales">
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>terramar/trabajadores/guardar_personales" method="post" >
						
						<input type="hidden" name="rut" value="<?php echo $datos_usuario->rut_usuario ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="text" name="rut1" id="rut1" value='<?php echo $datos_usuario->rut_usuario ?>' class="form-control">
								<?php }else{ ?>
								<input type="text" name="rut1" id="rut1" value='<?php echo $datos_usuario->rut_usuario ?>' class="form-control" disabled="disabled">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" v-model="fecha_nacimiento" class="form-control" value="<?php echo $datos_usuario->fecha_nac ?>" name="fecha_nacimiento" id="fecha_nacimiento" data-input>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" id="fono2" name='fono2' value="<?php echo $datos_usuario->telefono2 ?>" class="form-control">
							</div>
						</div>
						<div class="form-group">
				...
				<div class="tab-pane fade" id="contacto-emergencia" >
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>terramar/trabajadores/guardar_datos_de_emergencia/<?php echo $id_usuario ?>" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-tecnicos">
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>terramar/trabajadores/guardar_tecnicos" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-extras">
					<h2>Datos Extras</h2>
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>terramar/trabajadores/guardar_extra" method="post" >
						<input type="hidden" name="id" value="<?php echo $id_usuario ?>" >
						<div class="form-group">
					...
					<form enctype="multipart/form-data" action="<?php echo  base_url() ?>terramar/trabajadores/guardar_archivo/<?php echo $id_usuario ?>" method="post" class="form-horizontal" >
						<div class="form-group">
						...
						<?php foreach ($lista_archivos_subidos as $a) { ?>
							<tr>
								...
								<td>
									...
									&nbsp;&nbsp;
									<a title="Eliminar" class="eliminar" href="<?php echo base_url() ?>terramar/trabajadores/eliminar_archivo/<?php echo $a->id_archivo ?>/<?php echo $id_usuario ?>"><i class="fa fa-trash-o"></i></a> 
								</td>
							</tr>
						<?php } ?>
						</table>
				...
				<div class="tab-pane fade" id="datos-examenes">
					...
					<a class="btn btn-blue pull-right" style="margin-left:10px;" href="<?php echo base_url() ?>terramar/trabajadores/crear_examen/<?php echo $id ?>">Nuevo Examen</a>
								...
								<tr>
									...
									<td class="center" style="width:66px;">
										...
										<div class="visible-md visible-lg hidden-sm hidden-xs">
											<a href="<?php echo base_url() ?>terramar/trabajadores/eliminar_examen/<?php echo $id ?>/<?php echo $l->id ?>" class="btn btn-xs btn-red tooltips eliminar" data-id="<?php echo $l->id ?>" data-placement="top" data-original-title="Eliminar"><i class="fa fa-times fa fa-white"></i></a>
											<?php if($l->id_tipo == 1){ ?>
                  							<a data-toggle="modal" href="<?php echo base_url() ?>terramar/trabajadores/modal_editar_desempeno/<?php echo $l->id ?>/<?php echo $id ?>" class="btn btn-xs btn-blue pull-right editar" data-target="#ModalEditar"><i class="fa fa-edit"></i></a>
											<?php }elseif($l->id_tipo == 3){ ?>
                  							<a data-toggle="modal" href="<?php echo base_url() ?>terramar/trabajadores/modal_editar_conocimiento/<?php echo $l->id ?>/<?php echo $id ?>" class="btn btn-xs btn-blue pull-right editar" data-target="#ModalEditar"><i class="fa fa-edit"></i></a>
											<?php }else{ ?>
											<a href="<?php echo ($l->id_tipo == 4)? base_url().'terramar/trabajadores/crear_masso/'.$id.'/'.$l->id : base_url().'terramar/trabajadores/crear_examen/'.$id.'/'.$l->id; ?>" class="btn btn-xs btn-blue pull-right editar" data-original-title="Editar"><i class="fa fa-edit"></i></a>
											<?php } ?>
										</div>
									<?php } ?>
									</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url() ?>terramar/trabajadores/guardar_exam_desempeno" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
          <div class="col-md-6">
...
<div class="modal fade" id="ModalAgregarConocimiento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url() ?>terramar/trabajadores/guardar_exam_conocimientos" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
          <div class="col-md-6">
            <div class="control-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo base_url() ?>terramar/trabajadores/guardar_experiencia" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
          <div class="col-md-6">
            <div class="control-group">
