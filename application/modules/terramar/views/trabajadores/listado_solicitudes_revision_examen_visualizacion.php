				...
				<table id="example1">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?php echo base_url() ?>terramar/trabajadores/trabajador_terramar/<?php echo $row->usuario_id ?>" target="_blank"><?php echo $row->nombres ?></a></td>
								...
								<?php if($row->examen_masso != 0){ ?>
									...
									<?php }else{
										if($row->id_sre_agenda_masso != NULL)
											echo "<span class='badge' style='background-color:#D7DF01'>EP</span><a href='".base_url()."terramar/trabajadores/modal_agendar_examen/".$row->id_solicitud."/1/1' data-toggle='modal' data-target='#ModalEditar'><font color='blue'>Agendado</a></font>";
										else
								...
								<?php if($row->examen_preo != 0){ ?>
									...
									<?php }else{
										if($row->id_sre_agenda_preo != NULL)
											echo "<span class='badge' style='background-color:#D7DF01'>EP</span><a href='".base_url()."terramar/trabajadores/modal_agendar_examen/".$row->id_solicitud."/2/1' data-toggle='modal' data-target='#ModalEditar'><font color='blue'>Agendado</font></a>";
										else
											echo "<span class='badge' style='background-color:#D7DF01'>EP</span><br><font color='red'>No Agendado</font>";
									} ?>
								<?php } ?>
							...
							<td style="text-align:center">
								<?php if($row->examen_psicologico != 0){ ?>
									<?php if($row->eval_psic_id != NULL){ ?>
										...
										<a href="<?php echo base_url() ?>terramar/examen_psicologico/detalle/<?php echo $row->eval_psic_id ?>" style='color:<?php echo $row->color_psic ?>' target="_blank"><?php echo $row->examen_psic; ?></a><br>
										<?php }else{ ?>
									...
									<?php }else{
										if($row->id_sre_agenda_psic != NULL)
											echo "<span class='badge' style='background-color:#D7DF01'>EP</span><a href='".base_url()."terramar/trabajadores/modal_agendar_examen/".$row->id_solicitud."/3/1' data-toggle='modal' data-target='#ModalEditar'><font color='blue'>Agendado</font></a>";
										else
											echo "<span class='badge' style='background-color:#D7DF01'>EP</span><br><font color='red'>No Agendado</font>";
									} ?>
								<?php } ?>
