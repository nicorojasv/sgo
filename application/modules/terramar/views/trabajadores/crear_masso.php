...
.arauco {color:#009900;}
	...
	<div class="panel-heading">
		<h4 class="panel-title">A&ntilde;adir Evaluaci&oacute;n Masso <a href="<?php echo base_url() ?>terramar/trabajadores/detalle/<?php echo $id ?>"><i class="fa fa-reply"></i></a></h4>
