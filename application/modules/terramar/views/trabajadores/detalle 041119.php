		...
		<div class="tabbable tabs-left">
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade" id="datos-imagen">
					...
					<form enctype="multipart/form-data" role="form" class="form-horizontal" action="<?php echo  base_url() ?>terramar/trabajadores/guardar_imagen/<?php echo $id_usuario ?>" method="post" >
						<div class="form-group">
				...
				<div class="tab-pane fade" id="datos-pass">
					<form action="<?php echo base_url() ?>terramar/trabajadores/renovar_pass" method="post" class="form-horizontal" >
				...
				<div class="tab-pane fade" id="datos-examenes">
					...
					<a class="btn btn-blue pull-right" href="<?php echo base_url() ?>terramar/trabajadores/crear_masso/<?php echo $id ?>">Nuevo Masso</a>
					<table class='table'>
						<thead>
							<th>Tipo Examen</th>
