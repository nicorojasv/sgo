  ...
  <div class="panel-body">
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <select class="form-control" onchange="location = this.value">
              <option value="<?php echo base_url() ?>terramar/contratos/solicitudes_completas">[Todas]</option>
              <?php foreach($listado_plantas as $ep){ ?>
              <option value="<?php echo base_url() ?>terramar/contratos/solicitudes_completas/<?php echo $ep->id ?>" <?php if($planta_seleccionada == $ep->id) echo "selected" ?> ><?php echo $ep->nombre ?></option>
              <?php } ?>
            </select>
          </div>
                    <div class="col-md-8" align="left">
              <label for="datepickerTerramarCompletas">Mes A Consultar: </label>
              <input name="datepicker" type="text" id="datepickerTerramarCompletas" style="border: 1px solid #ccc;" class="datepicker" value="<?php if(isset($mes)) echo $mes ?>" size="10" readonly="true" title="Fecha a Gestionar Asistencia"><br>
      ...
      <div class="col-md-3" align="center">
            <form action="<?php echo base_url() ?>terramar/contratos/exportar_excel_contratos_y_anexos" method="post" target="_blank" id="FormularioExportacion">
              ...
              var idQuitar = $(this).attr('data-quitar');
                alertify.prompt('Baja de Contrato',"Contrato de "+nombre+".<br><br>Especifique motivo de solicitud de baja.", "",
                  function(evt, value ){// si presiona ok hacer esto
                    $.ajax({
                        type: "POST",
                        url: base_url+"terramar/contratos/solicitud_bajar_contrato/"+service,
