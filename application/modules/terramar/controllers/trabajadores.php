...
class Trabajadores extends CI_Controller{
	public function __construct(){
		...
		elseif( $this->session->userdata('tipo_usuario') == 18)
			$this->menu = $this->load->view('layout2.0/menus/menu_terramar','',TRUE);
	...
	function index(){
		...
		$base = array(
			...
			'subtitulo' => '<b>Unidad de Negocio:</b> terramar',
			'side_bar' => true,
		...
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/listado_general',$pagina,TRUE);
	...
	function crear(){
		...
		$this->load->model("terramar/Usu_parentesco_model");
		$this->load->model("terramar/Profesiones_model");

		$base = array(
			'head_titulo' => "Sistema EST - Datos Trabajador",
			'titulo' => "Empresa:  terramar S.A.",
			'side_bar' => true,
		...
		$pagina['lista_profesiones'] = $this->Profesiones_model->listar();
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/crear_trabajador',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function detalle($id){
		...
		$base = array(
			...
			'titulo' => "Empresa:terramar S.A.",
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Datos Trabajador')),
		...
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/detalle',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function eliminar_trabajador($id_usuario){
		...
		redirect('terramar/trabajadores', 'refresh');
	}
	...
	function guardar_nuevo_trabajador(){
		...
		redirect('terramar/trabajadores/detalle/'.$id_usuario.'#datos-personales', 'refresh');
	}
...
,			'fono' => $_POST['fono1'],
	...
	function guardar_datos_de_emergencia(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('terramar/trabajadores/detalle/'.$id_usuario.'#contacto-emergencia', 'refresh');
	}
	...
	function guardar_tecnicos(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('terramar/trabajadores/detalle/'.$id_usuario.'#datos-tecnicos', 'refresh');
	}
	...
	function guardar_extra(){
		...
		$this->Usuarios_model->editar($id_usuario,$data);
		redirect('terramar/trabajadores/detalle/'.$id_usuario.'#datos-extras', 'refresh');
	}

		function contratos_y_anexos(){
		$this->load->model("terramar/Usuarios_model");
		$base = array(
			'head_titulo' => "EST terramar",
			'titulo' => "Empresas: terramar",
		...
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/base_datos_contratos_y_anexos',$pagina,TRUE);
	 	$this->load->view('layout2.0/layout',$base);
	}
...
/*	function exportar_excel_contratos_y_anexos(){
	...
	function anotaciones($id){
		...
		$base = array(
			...
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Anotaciones')),
			'menu' => $this->menu
		);
		$pagina ="";
	...
	function guardar_anotacion($id){
		...
		redirect('terramar/trabajadores/anotaciones/'.$id, 'refresh');
	}
	...
	function eliminar_anotacion($id_usuario,$id_anotacion){
		...
		redirect('terramar/trabajadores/anotaciones/'.$id_usuario, 'refresh');
	}
	/*END Lista Negra*/
	function crear_examen($id,$id_evaluacion=FALSE){
		...
		$this->load->model("terramar/Evaluaciones_model");
		$this->load->model("terramar/Usuarios_model");
		$this->load->model("terramar/Evaluacionestipo_model");
		$this->load->model("terramar/Evaluacionesevaluacion_model");
		$this->load->model("terramar/Evaluacionesbaterias_model");
		$this->load->model("terramar/Evaluacionescargos_model");
		$usr = $this->Usuarios_model->get($id);
		$base = array(
			'head_titulo' => "Sistema EST",
			'titulo' => "Empresa: terramar S.A.",
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores/detalle/'.$id.'','txt'=>'Datos Trabajador '.$usr->nombres.'' ), array('url'=>'','txt'=>'Agregar Examen Preocupacional' )),
		...
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/crear_examen',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function guardar_creacion_eval($id_usr, $id_evalua=FALSE){
		$this->load->model("terramar/Usuarios_model");
		$this->load->model("terramar/Evaluaciones_model");
		$this->load->model("terramar/Evaluacionesarchivo_model");
		$this->load->model("terramar/Evaluacionesbaterias_model");
		$this->load->model("terramar/Evaluacionescargos_model");
		$this->load->helper("archivo");

		if(empty($id_usr)){
			redirect('terramar/trabajadores/detalle/'.$id_usr.'#datos-examenes', 'refresh');
		}
	...
	function listado_solicitudes_revision_examenes(){
		...
		$this->load->model('terramar/Solicitud_revision_examenes_previos_model');
		$this->load->model('terramar/Usuarios_model');
		$this->load->model('terramar/ciudades_model');
		$this->load->model('terramar/Cargos_model');
		$this->load->model('terramar/Empresa_planta_model');
		...
		$this->load->model('terramar/Sre_evaluacion_req_agenda_model');
		...
		$base = array(
			...
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores/buscar_js','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Listado Trabajadores Revision Examenes Pendientes' ) ),
			'menu' => $this->menu,
		...
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/listado_solicitudes_revision_examen',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function solicitudes_revision_examenes(){
		...
		$base = array(
			...
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores/buscar_js','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Listado Trabajadores Revision Examenes' ) ),
			'menu' => $this->menu,
		...
		$pagina['lista_requerimientos'] = $this->Requerimientos_model->r_listar_activos();
		$pagina['r_cargos'] = $this->Cargos_model->r_listar();
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/listado_envio_solicitud_revision_examen',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function trabajador_terramar($id, $id_evaluacion = FALSE){
		//$this->load->model("terramar/Tipoarchivos_model");
		$this->load->model("terramar/Archivos_trab_model");
		$this->load->model("terramar/estado_civil_model");
		$this->load->model("terramar/Usuarios_model");
		$this->load->model("terramar/regiones_model");
		//$this->load->model("terramar/Provincia_model");
		$this->load->model("terramar/ciudades_model");
		//$this->load->model("terramar/Bancos_model");
		$this->load->model("terramar/Afp_model");
		$this->load->model("terramar/Salud_model");
		//$this->load->model("terramar/Nivelestudios_model");
		$this->load->model("terramar/Usu_parentesco_model");
		$this->load->model("terramar/Profesiones_model");
		//$this->load->model("terramar/Especialidadtrabajador_model");
		//$this->load->model("terramar/Experiencia_model");
		$this->load->model("terramar/Evaluaciones_model");
		//Masso
		//$this->load->model('terramar/Evaluacionestipo_model');
		//$this->load->model('terramar/Evaluacionesbaterias_model');
		...
		$base = array(
			...
			'subtitulo' => 'Unidad de Negocio: Celulosa Nueva Aldea',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores/buscar_js','txt'=>'Trabajadores EST' ), array('url'=>'','txt'=>'Datos Trabajadores' )),
		...
		$base['cuerpo'] = $this->load->view('trabajadores/trabajador_terramar',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function modal_editar_sre_eval_req($id_registro, $estado = FALSE, $idExamen = false){
		...
		$this->load->model("terramar/Cargos_model");
		$this->load->model("terramar/Solicitud_revision_examenes_model");
		$this->load->model("terramar/Examenes_psicologicos_model");
		...
		if ($idExamen) {// #08-01-2018 si vengo desde el perfil psicologo consultar sobre las fecha de vigencia del examen
			$this->load->model('terramar/Usuarios_model');
			$this->load->model('terramar/Examenes_psicologicos_model');
			$this->load->model('terramar/Examenes_psicologicos_archivos_model');
			$this->load->model('terramar/usuarios/Usuarios_general_model');
			$this->load->model('terramar/Empresa_planta_model');
			$this->load->model('terramar/Cargos_model');
			$this->load->model('terramar/Especialidadtrabajador_model');
		...
		$this->load->view('terramar/trabajadores/modal_editar_sre_evaluacion_req', $pagina);
	}
	...
	function modal_agendar_examen($id_solicitud, $tipo_examen, $estado = FALSE){
		...
		$this->load->view('terramar/trabajadores/modal_agendar_solicitud_examen',$pagina);
	}
	...
	function ingresar_agenda_de_examen(){
		...
		redirect('terramar/trabajadores/listado_solicitudes_revision_examenes', 'refresh');
	}
	...
	function solicitudes_revision_examenes_completas(){
		...
		$base = array(
			...
			'subtitulo' => 'Unidad de Negocio: terramar',
			'side_bar' => true,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/trabajadores/buscar_js','txt'=>'Listado Trabajadores' ), array('url'=>'','txt'=>'Listado Trabajadores Revision Examenes Completas' ) ),
			'menu' => $this->menu,
			'js' => array('js/confirm.js','plugins/DataTables/media/js/jquery.dataTables.min.js','plugins/DataTables/FixedColumns/js/dataTables.fixedColumns.min.js','js/lista_req.js'),
			'css' => array('plugins/DataTables/media/css/jquery.dataTables.min.css','plugins/DataTables/media/css/dataTables.bootstrap.min.css','plugins/DataTables/FixedColumns/css/fixedColumns.dataTables.css'),
		);
		...
		$pagina['lista_requerimientos'] = $this->Requerimientos_model->r_listar_activos();
		$pagina['r_cargos'] = $this->Cargos_model->r_listar();
		$base['cuerpo'] = $this->load->view('terramar/trabajadores/listado_solicitudes_revision_examen_visualizacion',$pagina,TRUE);
		$this->load->view('layout2.0/layout',$base);
	}
	...
	function eliminar_examen($id_usr, $id_evalua=FALSE){
		...
		redirect('terramar/trabajadores/detalle/'.$id_usr.'#datos-personales', 'refresh');	
	}
	function guardar_archivo($id){
		if($_FILES['documento']['error'] == 0){
			...
			if($_POST['select_archivo'] == 13){
				...
				foreach ($la as $l) {
				 	if( $l->id_tipoarchivo == 13)
				 		redirect('terramar/trabajadores/detalle/'.$id.'/archivo_repetido#datos-extras', 'refresh');
				}
			}
			...
			if($salida == 1)
				redirect('terramar/trabajadores/detalle/'.$id.'/archivo_error0#datos-extras', 'refresh');
			elseif($salida==2)
				redirect('terramar/trabajadores/detalle/'.$id.'/archivo_error1#datos-extras', 'refresh');
			else{
				$data = array(
					'id_usuarios' => $id,
					'nombre' => $nb_archivo,
				...
				redirect('terramar/trabajadores/detalle/'.$id.'/archivo_exito#datos-extras', 'refresh');
			}
		}
		else redirect('terramar/trabajadores/detalle/'.$id.'/archivo_vacio#datos-extras', 'refresh');
	}
	function rut_existe(){
		$this->load->model("terramar/Usuarios_model");
		if ( $_POST['rut'] ){
