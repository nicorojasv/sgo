...
class Requerimientos extends CI_Controller {
	...
	function usuarios_requerimiento($id_area_cargo, $id_usuario = FALSE){
		...
		$base = array(
			...
			'subtitulo' => '',
			'side_bar' => false,
			'lugar' => array(array('url' => 'usuarios/home', 'txt' => 'Inicio'), array('url'=>'terramar/requerimientos/listado','txt' => 'Listado Requerimientos'), array('url'=>'terramar/requerimientos/asignacion/'.(isset($r_area_cargo->requerimiento_id)?$r_area_cargo->requerimiento_id:'0').'','txt' => 'Area-Cargo Requerimiento'), array('url'=>'','txt'=>'Listado de usuarios' )),
			'menu' => $this->menu,
	...
	function actualizar_contrato_anexo_doc_contractual($id_usu_arch,$id_area_cargo){
		...
		$this->load->model('terramar/Afp_model');
		$this->load->model('terramar/Finiquitos_model');
		$this->load->model('terramar/Usuarios_model');
