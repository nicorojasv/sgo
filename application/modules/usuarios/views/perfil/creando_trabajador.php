<div class="panel panel-white">
	<div class="panel-heading">
		<h4 class="panel-title"><i class="fa fa-pencil-square"></i> AGREGANDO PERSONAL</h4>
	</div>
	...
	<?php if($this->session->userdata('tipo_usuario') == 1 or $this->session->userdata('tipo_usuario') == 2 or $this->session->userdata('tipo_usuario') == 4 or $this->session->userdata('tipo_usuario') == 8){ ?>
		<div class="tabbable tabs-left">
			<ul id="myTab2" class="nav nav-tabs">
				...
				<li >
					<a href="#contacto-emergencia"  style="cursor:not-allowed ">
						<i class="pink fa fa-warning"></i> Contacto de Emergencia
					</a>
				</li>
				<li>
					<a href="#datos-imagen" style="cursor:not-allowed ">
						<i class='pink fa fa-file-photo-o' ></i> Imagen
					</a>
				</li>
				<li>
					<a href="#datos-tecnicos" style="cursor:not-allowed ">
						<i class='pink fa fa-gears' ></i> Datos T&eacute;cnicos
					</a>
				</li>
				<li>
					<a href="#datos-extras" style="cursor:not-allowed ">
						<i class='pink fa fa-puzzle-piece' ></i> Datos Extras
					</a>
				</li>
				<li>
					<a href="#datos-pass" style="cursor:not-allowed ">
						<i class='pink fa fa-key' ></i> Cambiar Contrase&ntilde;a
					</a>
				</li>
				<li>
					<a href="#datos-experiencia" style="cursor:not-allowed ">
						<i class='pink fa fa-suitcase' ></i> Experiencia
					</a>
				</li>
				<li>
					<a href="#datos-examenes" style="cursor:not-allowed ">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="datos-personales">
					...
					<form id="app"   @submit="checkForm" class="form-horizontal" action="<?php echo base_url()?>usuarios/perfil/guardar_trabajador" method="post" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" v-model="fecha_nacimiento" required class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" data-input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text"  v-model="nombres" required name="nombres" value="" id="nombres" class="form-control" autocomplete="off" >
							</div>
						</div>
						<div class="form-group ">
							<label class="col-sm-2 control-label">
							...
							<div class="col-sm-9">
								<input type="text" v-model="paterno" required class="form-control" id="lastname" name="paterno" value="" autocomplete="off" >
							</div>
						</div>
						<div class="form-group ">
							<label class="col-sm-2 control-label">
							...
							<div class="col-sm-9">
								<input type="text" v-model="materno" required  class="form-control" id="lastnamem" name="materno" value="" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_region" id="select_region" required class="form-control" >
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_provincia" required id="select_provincia" class="form-control" >
									<option value="">Seleccione...</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_ciudad" required id="select_ciudad" class="form-control" >
									<option value="">Seleccione...</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" v-model="direccion" required name="direccion" id="direccion" value="" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_sexo" required id="select_sexo" class="form-control" >
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_afp" required id="select_afp" class="form-control">
									<option value="">Seleccione...</option>
									<?php foreach ($lista_afp as $la) { ?>
										<option value="<?php echo $la->id ?>" ><?php echo $la->desc_afp ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_salud" required id="select_salud" class="form-control">
									<option selected disabled>Seleccione...</option>
									<?php foreach ($lista_salud as $ls) { ?>
										<option value="<?php echo $ls->id ?>" ><?php echo $ls->desc_salud ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" required id="fono1" name='fono1' value=""  class="form-control" maxlength="9"  autocomplete="off">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email"  v-model="email" name="email" id="email" required value="" class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_civil" required id="select_civil" class="form-control" >
									<option value="">Seleccione...</option>
									<?php foreach ($lista_civil as $lc) { ?>
										<option value="<?php echo $lc->id ?>"  ><?php echo $lc->desc_estadocivil ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_nacionalidad" required id="select_nacionalidad" class="form-control" >
									<option value="">Seleccione... </option>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="select_bancos" required id="select_bancos" class="form-control">
									<?php foreach ($lista_bancos as $lb) { ?>
										<option value="<?php echo $lb->id ?>"><?php echo $lb->desc_bancos ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" required id="tipo_cuenta" name="tipo_cuenta" value="" class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" required id="n_cuenta" name="n_cuenta" value="" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-10 control-label"></label>
							<div class="col-sm-2">
								<button type="submit" id="crear_trabajador" class="btn btn-primary">
								Crear Trabajador
								</button>
							</div>
						</div>
				...
				<!--<div class="tab-pane fade" id="contacto-emergencia" >
					...
					<form role="form" class="form-horizontal" action="<?php echo  base_url() ?>usuarios/perfil/guardar_datos_de_emergencia/<?php echo $id_usuario ?>" method="post" >
						...
						<?php foreach ($lista_archivos_subidos as $a) { ?>
							<tr>
								...
								<td>
									...
									&nbsp;&nbsp;
									<a title="Eliminar" class="eliminar" href="<?php echo base_url() ?>usuarios/perfil/eliminar_archivo/<?php echo $a->id_archivo ?>/<?php echo $id_usuario ?>"><i class="fa fa-trash-o"></i></a> 
								</td>
							</tr>
						<?php } ?>
						</table>
				...
				<div class="tab-pane fade" id="datos-pass">
					<form action="<?php echo base_url() ?>usuarios/perfil/renovar_pass" method="post" class="form-horizontal" >
				...
				<div class="tab-pane fade" id="datos-examenes">
					...
					<a class="btn btn-blue pull-right" style="margin-left:10px;" href="<?php echo base_url() ?>usuarios/perfil/crear_examen/<?php echo $id ?>">Nuevo Examen</a>
					<a class="btn btn-blue pull-right" href="<?php echo base_url() ?>usuarios/perfil/crear_masso/<?php echo $id ?>">Nuevo Masso</a>
					<table class='table'>
						<thead>
							<th>Tipo Examen</th>
								...
								<tr>
									...
									<td class="center" style="width:66px;">
										...
										<div class="visible-md visible-lg hidden-sm hidden-xs">
											<a href="<?php echo base_url() ?>usuarios/perfil/eliminar_examen/<?php echo $id ?>/<?php echo $l->id ?>" class="btn btn-xs btn-red tooltips eliminar" data-id="<?php echo $l->id ?>" data-placement="top" data-original-title="Eliminar"><i class="fa fa-times fa fa-white"></i></a>
											<?php if($l->id_tipo == 1){ ?>
                  							<a data-toggle="modal" href="<?php echo base_url() ?>usuarios/perfil/modal_editar_desempeno/<?php echo $l->id ?>/<?php echo $id ?>" class="btn btn-xs btn-blue pull-right editar" data-target="#ModalEditar"><i class="fa fa-edit"></i></a>
											<?php }elseif($l->id_tipo == 3){ ?>
                  							<a data-toggle="modal" href="<?php echo base_url() ?>usuarios/perfil/modal_editar_conocimiento/<?php echo $l->id ?>/<?php echo $id ?>" class="btn btn-xs btn-blue pull-right editar" data-target="#ModalEditar"><i class="fa fa-edit"></i></a>
											<?php }else{ ?>
											<a href="<?php echo ($l->id_tipo == 4)? base_url().'usuarios/perfil/crear_masso/'.$id.'/'.$l->id : base_url().'usuarios/perfil/crear_examen/'.$id.'/'.$l->id; ?>" class="btn btn-xs btn-blue pull-right editar" data-original-title="Editar"><i class="fa fa-edit"></i></a>
											<?php } ?>
										</div>
									<?php } ?>
									</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url() ?>usuarios/perfil/guardar_exam_desempeno" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
          <div class="col-md-6">
...
<div class="modal fade" id="ModalAgregarConocimiento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url() ?>usuarios/perfil/guardar_exam_conocimientos" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
          <div class="col-md-6">
            <div class="control-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo base_url() ?>usuarios/perfil/guardar_experiencia" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data">
          <div class="col-md-6">
            <div class="control-group">
