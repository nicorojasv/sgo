<div class="panel panel-white">
	<div class="panel-heading">
		<h4 class="panel-title">A&ntilde;adir Evaluaci&oacute;n Medica <a href="<?php echo base_url() ?>usuarios/perfil/trabajador_est/<?php echo $id ?>"><i class="fa fa-reply"></i></a></h4>
	</div>
