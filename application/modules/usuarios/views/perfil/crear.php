		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input type="text" placeholder="Ingrese su apellido Materno" class="form-control" id="lastnamem" name="materno" value="<?php if(!empty($texto_anterior['materno'])) ?>" >
				</div>
				<div class="form-group">
					<label class="control-label">
			...
			<div class="col-md-6">
				<div class="form-group connected-group">
					...
					<div class="row">
						...
						<div class="col-md-7">
							<input type="phone" class="form-control" name="fono2" id="phone2" value="<?php if(!empty($texto_anterior['fono2'])) ?>" required>
						</div>
					</div>
				</div>
				<div class="form-group connected-group">
				...
				<div class="form-group ">
					...
					<div class="row">
						<div class="col-md-9">
							<select name="tipo_usuario" id="tipo_usuario" class="form-control" <?php //echo ($tipo)?'disabled':''; ?> required>
								<option value="3" >Est</option>
								<!--<?php //foreach ($lista_tipo as $l) { ?>
									<option value="<?php //echo $l->id ?>" <?php //echo ($tipo == $l->id)?'SELECTED':''; ?> ><?php //echo $l->nombre ?></option>
								<?php //} ?>-->
							</select>
							<!--<?php //if($tipo){ ?>
				...
				<div class="form-group ">
					...
					<div class="row">
						<div class="col-md-9">
							<select name="cargo" id="cargo" class="form-control" <?php //echo ($tipo)?'disabled':''; ?> required>
				...
				<div class="form-group">
					<hr>
					<label class="control-label">
						<strong>Chat</strong> <span class="symbol required"></span>
					</label>
					<p>
						Activar el acceso a chat?
					</p>
					<div>
						<label class="radio-inline">
							<input type="radio" class="grey" value="0" name="chat" style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" checked>
							No
						</label>
						<label class="radio-inline">
							<input type="radio" class="grey" value="1" name="chat" style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);">
							Si
						</label>
					</div>
				</div>
				<div class="form-group">
					<hr>
					<label class="control-label">
						<strong>Aviso Cumpleaños?</strong></span>
					</label>
					<p>
						Enviar correos de saludo?
					</p>
					<div>
						<label class="radio-inline">
							<input type="radio" class="grey" value="0" name="cumple" style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" checked>
							No
						</label>
						<label class="radio-inline">
							<input type="radio" class="grey" value="1" name="cumple" style="position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);">
							Si
						</label>
					</div>
				</div>
