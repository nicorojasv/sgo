<div id="modal">
  <div class="modal-header" style="text-align:center">
    ...
    <h4 class="modal-title" id="exampleModalLabel">Actualizaci&oacute;n Datos Examen de Desempeño</h4>
  </div>
    ...
    <form action="<?php echo base_url() ?>usuarios/perfil/modificar_exam_conocimientos_desempeno" role="form" id="form2" method='post' name="f2" enctype="multipart/form-data" autocomplete="off">
      ...
      <div class="col-md-6">
            <div class="control-group">
              <label class="control-label" for="inputTipo">Tipo de Examen de Desempeño</label>
                <div class="controls">
                  ...
                  <select name="id_tipo_eval" id="id_tipo_eval" style="width:260px" required>
                    <?php foreach ($exam_desempeno as $key2) {  ?>
