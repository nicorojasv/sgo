...
.arauco {color:#009900;}
	...
	<div class="panel-heading">
		<h4 class="panel-title">A&ntilde;adir Evaluaci&oacute;n Masso <a href="<?php echo base_url() ?>usuarios/perfil/trabajador_est/<?php echo $id ?>"><i class="fa fa-reply"></i></a></h4>
	...
	<div class="panel-body">
		<form class="form-horizontal" id="agregar_examen" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>usuarios/perfil/guardar_creacion_eval/<?php echo $id ?>/<?php if($eval){ echo $eval->id; } ?>">
				...
				<div class='col-md-6' >
					<div class="panel panel-white">
						...
						<div class="panel-body">
							...
							<div class="actions">
								<?php 
								if($this->session->userdata('id') == 39 || $this->session->userdata('tipo_usuario')==8 || $this->session->userdata('id') == 99 || $this->session->userdata('id') == 97 || $this->session->userdata('id') == 10){
								?>
