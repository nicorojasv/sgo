	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						Especialidad: <b><?php echo @ucwords(mb_strtolower($this->Especialidadtrabajador_model->get($usuario->id_especialidad_trabajador_2)->desc_especialidad, 'UTF-8')); ?></b><br/>
						<?php } ?>
						...
						, <?php echo ucwords(mb_strtolower($this->Provincia_model->get($usuario->id_provincias)->desc_provincias, 'UTF-8')); ?>
						<?php } ?></b><br />
			...
			<div class="col-md-6">
				...
				¿Desea actualizarlo? <a href="<?php echo base_url() ?>trabajador_est/perfil/editar#datos-personales">si</a> / <a href="javascript:;">no</a></p>
				<br>
