<div class="panel panel-white">
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-3">
				<a href="javascript:history.back()" id="question_button" class="btn primary xlarge block"><?php echo $pag_lugar ?></a>
				<br>
				<div class="box">
					...
					<ul>
						...
						<li>
							<a href="<?php echo base_url() ?>trabajador/noticias/detalle/<?php echo urlencode(base64_encode($nt->noticia_id)) ?>"><?php echo ucwords(mb_strtolower($nt->titulo, 'UTF-8')); ?></a>
						</li>
						<?php } ?>
					</ul>
					<?php } else{ ?>
