...
<li class="clickButtonMenu <?php if(isset($nombre)){ if($nombre === 'listado')echo "active"; }?> " data="1.9-listado">
	<a href="<?php echo base_url() ?>enjoy/requerimientos/agregar"><i class="fa fa-home"></i> <span class="title">Agregar Requerimientos </span></a>
</li>
