...
<li>
	...
	<ul class="sub-menu" <?php if(isset($menu)){if($menu == '1.4')echo "style='display: block;'"; }?>>
		<li class="clickButtonMenu <?php if(isset($nombre)){ if($nombre === 'sol_pendientes')echo "active"; }?> " data="1.4-sol_pendientes">
		...
		<li class="clickButtonMenu <?php if(isset($nombre)){ if($nombre === 'sol_completas')echo "active"; }?> " data="1.4-sol_completas">
...
<li  class=" clickButtonMenu <?php if(isset($nombre)){ if($nombre === 'enjoy_asistencia')echo "active"; }?> " data="1.5-enjoy_asistencia">
	<a href="<?php echo base_url() ?>enjoy/asistencia"><i class="fa fa-home"></i> <span class="title"> Asistencia </span> <span class="badge"> NEW</span></a>
</li>
<!--1.6-->
