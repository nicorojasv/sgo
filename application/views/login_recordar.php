			...
			<div class="row">
		    	...
		    	<div id="content">
		    		<div id="auth_dialog_container" class="login_form">
		    			<div id="auth_dialog">
		    				<h3><span>Para obtener su contraseña, favor ingrese su Rut</span></h3>
		    				<form action="<?php echo base_url() ?>login/validar_correo" method="post" novalidate="" style="display: block; ">
		    					<div class="big_input control_holder">
		    						<label style="display: none" class="main_label" for="login_form_email">Rut </label>
		    						<input name="rut" id="login_form_rut" tabindex="1" class="text_field" type="email" placeholder="Rut">
		    					</div>
		    					<div class="login_action">
		    						<div class="button_holder"><br/>
		    							<button tabindex="5" class="default" type="submit" accesskey="s">Enviar Contraseña</button>
		    						</div>
		    					</div>
